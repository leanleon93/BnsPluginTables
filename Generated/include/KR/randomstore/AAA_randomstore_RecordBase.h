...
int charge_of_item_draw_tableId() const {return 204;};
__int64 charge_of_money_draw;
BnsTables::Shared::TableRef charge_of_item_instant_payment_draw;
int charge_of_item_instant_payment_draw_tableId() const {return 204;};
BnsTables::Shared::TableRef charge_of_item_five_times_draw;
int charge_of_item_five_times_draw_tableId() const {return 204;};
...
int charge_of_item_instant_payment_five_times_draw_tableId() const {return 204;};
