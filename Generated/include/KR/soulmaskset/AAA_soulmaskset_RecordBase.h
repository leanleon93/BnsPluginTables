...
int context_script_tableId() const {return 80;};
...
int transform_appearance_jin_tableId() const {return 90;};
BnsTables::Shared::TableRef transform_appearance_gon;
int transform_appearance_gon_tableId() const {return 90;};
BnsTables::Shared::TableRef transform_appearance_kun;
int transform_appearance_kun_tableId() const {return 90;};
