...
int transform_appearance_tableId(){return 85;};
wchar_t* transform_animset;
BnsTables::Shared::TableRef transform_equip_hand_appearance;
int transform_equip_hand_appearance_tableId(){return 195;};
...
int transform_appearance_jin_tableId(){return 85;};
BnsTables::Shared::TableRef transform_appearance_gon;
int transform_appearance_gon_tableId(){return 85;};
BnsTables::Shared::TableRef transform_appearance_kun;
int transform_appearance_kun_tableId(){return 85;};
