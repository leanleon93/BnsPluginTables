...
int context_script_tableId() const {return 79;};
BnsTables::Shared::TableRef transform_appearance;
int transform_appearance_tableId() const {return 89;};
wchar_t* transform_animset;
BnsTables::Shared::TableRef transform_equip_hand_appearance;
int transform_equip_hand_appearance_tableId() const {return 206;};
...
int transform_appearance_jin_tableId() const {return 89;};
BnsTables::Shared::TableRef transform_appearance_gon;
int transform_appearance_gon_tableId() const {return 89;};
BnsTables::Shared::TableRef transform_appearance_kun;
int transform_appearance_kun_tableId() const {return 89;};
