...
int progress_talksocial_tableId() const {return 435;};
...
int giveup_zone_tableId() const {return 486;};
BnsTables::Shared::TableRef giveup_warp_to_pcspawn;
int giveup_warp_to_pcspawn_tableId() const {return 495;};
