...
int progress_talksocial_tableId() const {return 441;};
...
int giveup_zone_tableId() const {return 492;};
BnsTables::Shared::TableRef giveup_warp_to_pcspawn;
int giveup_warp_to_pcspawn_tableId() const {return 501;};
