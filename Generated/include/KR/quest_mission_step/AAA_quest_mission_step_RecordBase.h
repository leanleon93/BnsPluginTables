...
int progress_talksocial_tableId() const {return 438;};
...
int giveup_zone_tableId() const {return 489;};
BnsTables::Shared::TableRef giveup_warp_to_pcspawn;
int giveup_warp_to_pcspawn_tableId() const {return 498;};
