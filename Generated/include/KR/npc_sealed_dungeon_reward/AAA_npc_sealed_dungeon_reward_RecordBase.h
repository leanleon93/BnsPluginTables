...
int reward_default_tableId() const {return 343;};
BnsTables::Shared::TableRef reward_event;
int reward_event_tableId() const {return 343;};
BnsTables::Shared::TableRef reward_personal_dropped_pouch;
int reward_personal_dropped_pouch_tableId() const {return 343;};
BnsTables::Shared::TableRef reward_personal_dropped_pouch_event;
int reward_personal_dropped_pouch_event_tableId() const {return 343;};
