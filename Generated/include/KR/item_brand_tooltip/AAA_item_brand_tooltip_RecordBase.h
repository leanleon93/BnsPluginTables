...
int main_info_tableId() const {return 425;};
...
int description4_title_tableId() const {return 425;};
BnsTables::Shared::TableRef description5_title;
int description5_title_tableId() const {return 425;};
BnsTables::Shared::TableRef description6_title;
int description6_title_tableId() const {return 425;};
...
int description6_tableId() const {return 425;};
BnsTables::Shared::TableRef store_description;
int store_description_tableId() const {return 425;};
