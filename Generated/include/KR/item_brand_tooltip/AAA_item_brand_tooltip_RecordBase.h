...
int description4_title_tableId(){return 420;};
BnsTables::Shared::TableRef description5_title;
int description5_title_tableId(){return 420;};
BnsTables::Shared::TableRef description6_title;
int description6_title_tableId(){return 420;};
BnsTables::Shared::TableRef description4;
int description4_tableId(){return 420;};
BnsTables::Shared::TableRef description5;
int description5_tableId(){return 420;};
BnsTables::Shared::TableRef description6;
int description6_tableId(){return 420;};
BnsTables::Shared::TableRef store_description;
int store_description_tableId(){return 420;};
