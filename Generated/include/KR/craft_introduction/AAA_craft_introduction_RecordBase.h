...
int slogan_tableId() const {return 425;};
BnsTables::Shared::TableRef introduction_description;
int introduction_description_tableId() const {return 425;};
