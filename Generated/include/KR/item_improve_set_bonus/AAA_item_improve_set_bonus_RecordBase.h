...
__int32 target_item_condition_type_Size() const {return 40;};
signed char target_equip_pos[40];
__int32 target_equip_pos_Size() const {return 40;};
BnsTables::Shared::IconRef target_equip_pos_icon[40];
__int32 target_equip_pos_icon_Size() const {return 40;};
...
int total_improve_level_effect_tableId() const {return 120;};
...
int total_improve_level_effect_description_tableId() const {return 445;};
...
int total_improve_level_condition_event_tableId() const {return 66;};
...
int min_improve_level_effect_tableId() const {return 120;};
...
int min_improve_level_effect_description_tableId() const {return 445;};
