...
int total_improve_level_effect_tableId(){return 115;};
BnsTables::Shared::TableRef total_improve_level_effect_description[30];
int total_improve_level_effect_description_tableId(){return 420;};
...
int total_improve_level_condition_event_tableId(){return 63;};
__int16 min_improve_level[30];
BnsTables::Shared::TableRef min_improve_level_effect[30];
int min_improve_level_effect_tableId(){return 115;};
BnsTables::Shared::TableRef min_improve_level_effect_description[30];
int min_improve_level_effect_description_tableId(){return 420;};
...
int min_improve_level_condition_event_tableId(){return 63;};
