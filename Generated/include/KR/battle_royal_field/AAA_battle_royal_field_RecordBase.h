...
int public_raid_tableId() const {return 309;};
...
int available_party_mode_matching_weekly_time_tableId() const {return 471;};
...
int extra_skill_context_script_tableId() const {return 79;};
