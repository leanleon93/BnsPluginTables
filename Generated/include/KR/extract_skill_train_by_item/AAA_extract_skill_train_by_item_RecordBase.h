...
int skill_train_by_item_tableId() const {return 391;};
...
int skill_train_by_item_extract_cost_group_tableId() const {return 81;};
BnsTables::Shared::TableRef extract_skill_train_by_item;
int extract_skill_train_by_item_tableId() const {return 206;};
