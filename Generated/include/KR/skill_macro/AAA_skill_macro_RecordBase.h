...
#pragma pack(push, 1)
	struct skill_macro_Record : BnsTables::Shared::DrEl
	{
	public:
		union Key
		{
...
#pragma pack(pop)
#pragma pack(push, 1)
	struct __declspec(align(4)) skill_macro_RecordPtr // : DrRecordPtr
	{
		skill_macro_Record* _record;
