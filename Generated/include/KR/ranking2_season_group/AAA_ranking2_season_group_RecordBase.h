...
int contents_tableId() const {return 315;};
...
int main_season_tableId() const {return 319;};
...
int tier_contents_seasons_tableId() const {return 320;};
BnsTables::Shared::TableRef tier;
int tier_tableId() const {return 322;};
