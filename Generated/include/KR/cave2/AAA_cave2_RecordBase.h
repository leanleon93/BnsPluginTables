...
int cave2_name2_tableId() const {return 444;};
BnsTables::Shared::TableRef cave2_desc;
int cave2_desc_tableId() const {return 444;};
...
int quest_for_ignoring_required_level_tableId() const {return 312;};
...
int tactic_tableId() const {return 444;};
