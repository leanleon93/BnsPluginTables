...
int cave2_name2_tableId() const {return 441;};
BnsTables::Shared::TableRef cave2_desc;
int cave2_desc_tableId() const {return 441;};
...
int quest_for_ignoring_required_level_tableId() const {return 310;};
...
int standard_gear_weapon_tableId() const {return 204;};
...
int tactic_tableId() const {return 441;};
