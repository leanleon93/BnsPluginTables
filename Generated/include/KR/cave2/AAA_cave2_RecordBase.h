...
int cave2_name2_tableId() const {return 447;};
BnsTables::Shared::TableRef cave2_desc;
int cave2_desc_tableId() const {return 447;};
...
int quest_for_ignoring_required_level_tableId() const {return 314;};
...
int tactic_tableId() const {return 447;};
