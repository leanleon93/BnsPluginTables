...
int group_alias_tableId() const {return 84;};
...
int requirement_name_tableId() const {return 444;};
BnsTables::Shared::TableRef location_desc;
int location_desc_tableId() const {return 444;};
...
int reward_item_random_distribution_tableId() const {return 323;};
