...
int arena_outside_alpha_side_pc_spawn_tableId(){return 470;};
BnsTables::Shared::TableRef arena_outside_beta_side_pc_spawn[3];
int arena_outside_beta_side_pc_spawn_tableId(){return 470;};
...
int loading_description_1_tableId(){return 420;};
BnsTables::Shared::TableRef loading_description_2;
int loading_description_2_tableId(){return 420;};
...
int duel_name2_tableId(){return 420;};
BnsTables::Shared::TableRef duel_desc;
int duel_desc_tableId(){return 420;};
...
int available_normal_matching_weekly_time_tableId(){return 446;};
BnsTables::Shared::TableRef available_ingame_championship_matching_weekly_time;
int available_ingame_championship_matching_weekly_time_tableId(){return 446;};
