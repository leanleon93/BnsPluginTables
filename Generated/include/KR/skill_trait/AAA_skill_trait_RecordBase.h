...
int tooltip_train_name_tableId() const {return 448;};
BnsTables::Shared::TableRef tooltip_train_description;
int tooltip_train_description_tableId() const {return 448;};
BnsTables::Shared::TableRef tooltip_effect_description;
int tooltip_effect_description_tableId() const {return 448;};
...
int tooltip_skill_systematization_group_tableId() const {return 390;};
...
int tooltip_acquire_skill_list_skill3_description_tableId() const {return 448;};
...
int tooltip_variable_skill_list_skill3_description_tableId() const {return 448;};
