...
int mapunit_tableId() const {return 263;};
__int16 range_min;
__int16 range_max;
...
int gadget_tableId() const {return 148;};
...
int valid_zone_tableId() const {return 489;};
...
int case_talksocial_tableId() const {return 438;};
