...
int step_complete_reward_item_tableId() const {return 207;};
...
int step_complete_reward_final_item_tableId() const {return 207;};
...
int title_image_text_tableId() const {return 447;};
BnsTables::Shared::TableRef title_thumbnail_icon_text;
int title_thumbnail_icon_text_tableId() const {return 447;};
__int16 sort_no;
char Pad9[2];
