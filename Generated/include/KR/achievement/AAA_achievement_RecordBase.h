...
int step_complete_reward_item_tableId() const {return 205;};
...
int step_complete_reward_final_item_tableId() const {return 205;};
...
int title_image_text_tableId() const {return 444;};
BnsTables::Shared::TableRef title_thumbnail_icon_text;
int title_thumbnail_icon_text_tableId() const {return 444;};
__int16 sort_no;
char Pad9[2];
BnsTables::Shared::TableRef completed_game_message;
int completed_game_message_tableId() const {return 162;};
