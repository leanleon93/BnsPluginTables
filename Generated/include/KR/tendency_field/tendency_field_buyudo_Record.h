...
int playable_time_tableId() const {return 461;};
...
int tendency_1_faction1_warfare_quest_tableId() const {return 307;};
...
int tendency_1_faction2_warfare_quest_tableId() const {return 307;};
...
int tendency_2_faction1_warfare_quest_tableId() const {return 307;};
...
int tendency_2_faction2_warfare_quest_tableId() const {return 307;};
...
int tendency_3_faction1_warfare_quest_tableId() const {return 307;};
...
int reentrance_faction1_spawn_tableId() const {return 489;};
BnsTables::Shared::TableRef reentrance_faction2_spawn;
int reentrance_faction2_spawn_tableId() const {return 489;};
