...
int sub_zone_tableId() const {return 461;};
...
int tendency_field_name2_tableId() const {return 420;};
BnsTables::Shared::TableRef tendency_field_desc;
int tendency_field_desc_tableId() const {return 420;};
