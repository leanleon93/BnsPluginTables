...
int main_zone_tableId() const {return 492;};
BnsTables::Shared::TableRef sub_zone[7];
__int32 sub_zone_Size() const {return 7;};
int sub_zone_tableId() const {return 492;};
...
int tendency_field_name2_tableId() const {return 447;};
BnsTables::Shared::TableRef tendency_field_desc;
int tendency_field_desc_tableId() const {return 447;};
