...
int none_selected_icon_texture_tableId() const {return 191;};
__int16 none_selected_icon_index;
char Pad1[2];
BnsTables::Shared::TableRef join_msg;
int join_msg_tableId() const {return 162;};
BnsTables::Shared::TableRef level_up_msg;
int level_up_msg_tableId() const {return 162;};
BnsTables::Shared::TableRef max_level_msg;
int max_level_msg_tableId() const {return 162;};
