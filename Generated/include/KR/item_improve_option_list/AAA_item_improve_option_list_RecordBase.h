...
int option_tableId() const {return 217;};
...
int draw_cost_main_item_tableId() const {return 207;};
...
int draw_cost_sub_item_1_tableId() const {return 207;};
...
int draw_cost_sub_item_2_tableId() const {return 207;};
...
int draw_cost_sub_item_3_tableId() const {return 207;};
...
int draw_cost_sub_item_4_tableId() const {return 207;};
...
int succession_random_option_tableId() const {return 217;};
