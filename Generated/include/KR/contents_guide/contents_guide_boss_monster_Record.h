...
int boss_id_tableId() const {return 282;};
BnsTables::Shared::TableRef linked_boss_id;
int linked_boss_id_tableId() const {return 282;};
BnsTables::Shared::TableRef boss_description;
int boss_description_tableId() const {return 444;};
BnsTables::Shared::TableRef boss_position_description;
int boss_position_description_tableId() const {return 444;};
