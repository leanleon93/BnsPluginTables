...
#pragma pack(push, 1)
	struct reinforce_skill_train_by_item_extract_Record : BnsTables::Shared::DrEl
	{
	public:
		union Key
		{
...
int cost_main_item_tableId() const {return 207;};
...
int cost_sub_item_1_tableId() const {return 207;};
...
int cost_sub_item_2_tableId() const {return 207;};
...
int cost_sub_item_3_tableId() const {return 207;};
...
int cost_sub_item_4_tableId() const {return 207;};
...
int cost_sub_item_5_tableId() const {return 207;};
...
#pragma pack(pop)
#pragma pack(push, 1)
	struct __declspec(align(4)) reinforce_skill_train_by_item_extract_RecordPtr // : DrRecordPtr
	{
		reinforce_skill_train_by_item_extract_Record* _record;
