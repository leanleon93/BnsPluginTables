...
int feed_item_tableId() const {return 205;};
BnsTables::Shared::TableRef feed_recipe;
int feed_recipe_tableId() const {return 229;};
BnsTables::Shared::TableRef start_item;
int start_item_tableId() const {return 205;};
signed char start_orientation;
char Pad_sub_1[3];
BnsTables::Shared::TableRef end_item;
int end_item_tableId() const {return 205;};
