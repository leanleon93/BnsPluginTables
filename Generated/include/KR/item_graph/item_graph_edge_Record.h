...
int feed_item_tableId() const {return 204;};
BnsTables::Shared::TableRef feed_recipe;
int feed_recipe_tableId() const {return 228;};
BnsTables::Shared::TableRef start_item;
int start_item_tableId() const {return 204;};
signed char start_orientation;
char Pad_sub_1[3];
BnsTables::Shared::TableRef end_item;
int end_item_tableId() const {return 204;};
