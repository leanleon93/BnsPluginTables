...
int title2_tableId() const {return 447;};
...
int store_tableId() const {return 427;};
BnsTables::Shared::TableRef store_by_item;
int store_by_item_tableId() const {return 426;};
BnsTables::Shared::TableRef store2[6];
__int32 store2_Size() const {return 6;};
int store2_tableId() const {return 425;};
...
int reward_default_tableId() const {return 350;};
...
int personal_dropped_pouch_reward_tableId() const {return 350;};
BnsTables::Shared::TableRef personal_dropped_pouch_event_reward;
int personal_dropped_pouch_event_reward_tableId() const {return 350;};
...
int personal_dropped_pouch_reward_difficulty_type_tableId() const {return 350;};
BnsTables::Shared::TableRef reward_sealed_dungeon;
int reward_sealed_dungeon_tableId() const {return 288;};
BnsTables::Shared::TableRef dungeon_challenge_reward;
int dungeon_challenge_reward_tableId() const {return 350;};
...
int action_name_tableId() const {return 447;};
BnsTables::Shared::TableRef action_desc;
int action_desc_tableId() const {return 447;};
BnsTables::Shared::TableRef manipulate_transit_zone;
int manipulate_transit_zone_tableId() const {return 492;};
...
int loot_quests_tableId() const {return 314;};
...
int finish_blow_quests_tableId() const {return 314;};
...
int default_idle_tableId() const {return 286;};
bool warfare_boss;
char Pad16[3];
__int64 max_hp;
__int16 max_sp;
...
int grade_tooltip_text_tableId() const {return 447;};
...
int end_talk_social_tableId() const {return 409;};
...
int dying_message_tableId() const {return 447;};
signed char role_type;
char Pad25[3];
BnsTables::Shared::TableRef die_shout;
int die_shout_tableId() const {return 447;};
...
int summoned_beauty_shop_tableId() const {return 429;};
...
int map_unit_tableId() const {return 265;};
...
int newbiecare_tableId() const {return 281;};
