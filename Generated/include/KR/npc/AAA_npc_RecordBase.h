...
int title2_tableId() const {return 425;};
...
int store_tableId() const {return 405;};
BnsTables::Shared::TableRef store_by_item;
int store_by_item_tableId() const {return 404;};
...
int action_name_tableId() const {return 425;};
...
int manipulate_transit_zone_tableId() const {return 468;};
...
int grade_tooltip_text_tableId() const {return 425;};
...
int dying_message_tableId() const {return 425;};
signed char role_type;
char Pad24[3];
BnsTables::Shared::TableRef die_shout;
int die_shout_tableId() const {return 425;};
...
int stand_social_tableId() const {return 387;};
...
int summoned_beauty_shop_tableId() const {return 407;};
