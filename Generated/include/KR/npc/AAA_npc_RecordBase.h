...
int store_tableId(){return 400;};
BnsTables::Shared::TableRef store_by_item;
int store_by_item_tableId(){return 399;};
...
int contribution_reward_tableId(){return 76;};
BnsTables::Shared::TableRef contribution_day_reward_sun;
int contribution_day_reward_sun_tableId(){return 76;};
BnsTables::Shared::TableRef contribution_day_reward_mon;
int contribution_day_reward_mon_tableId(){return 76;};
BnsTables::Shared::TableRef contribution_day_reward_tue;
int contribution_day_reward_tue_tableId(){return 76;};
BnsTables::Shared::TableRef contribution_day_reward_wed;
int contribution_day_reward_wed_tableId(){return 76;};
BnsTables::Shared::TableRef contribution_day_reward_thu;
int contribution_day_reward_thu_tableId(){return 76;};
BnsTables::Shared::TableRef contribution_day_reward_fri;
int contribution_day_reward_fri_tableId(){return 76;};
BnsTables::Shared::TableRef contribution_day_reward_sat;
int contribution_day_reward_sat_tableId(){return 76;};
...
int personal_dropped_pouch_reward_tableId(){return 326;};
BnsTables::Shared::TableRef personal_dropped_pouch_reward_difficulty_type[3];
int personal_dropped_pouch_reward_difficulty_type_tableId(){return 326;};
BnsTables::Shared::TableRef reward_sealed_dungeon;
int reward_sealed_dungeon_tableId(){return 269;};
BnsTables::Shared::TableRef fielditemdrop;
int fielditemdrop_tableId(){return 143;};
BnsTables::Shared::TableRef deadbody_fielditemdrop;
int deadbody_fielditemdrop_tableId(){return 143;};
...
int finish_blow_quests_tableId(){return 294;};
...
int default_idle_tableId(){return 267;};
bool warfare_boss;
char Pad16[3];
__int64 max_hp;
__int16 max_sp;
...
int summoned_beauty_shop_tableId(){return 402;};
...
int map_unit_tableId(){return 249;};
...
int newbiecare_tableId(){return 263;};
