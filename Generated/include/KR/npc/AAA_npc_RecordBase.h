...
int title2_tableId() const {return 448;};
...
int store_tableId() const {return 428;};
BnsTables::Shared::TableRef store_by_item;
int store_by_item_tableId() const {return 427;};
BnsTables::Shared::TableRef store2[6];
__int32 store2_Size() const {return 6;};
int store2_tableId() const {return 426;};
BnsTables::Shared::TableRef teleport;
int teleport_tableId() const {return 444;};
bool repairer;
...
int event_reward_tableId() const {return 351;};
BnsTables::Shared::TableRef reward_default;
int reward_default_tableId() const {return 351;};
...
int personal_dropped_pouch_reward_tableId() const {return 351;};
BnsTables::Shared::TableRef personal_dropped_pouch_event_reward;
int personal_dropped_pouch_event_reward_tableId() const {return 351;};
...
int personal_dropped_pouch_reward_difficulty_type_tableId() const {return 351;};
BnsTables::Shared::TableRef reward_sealed_dungeon;
int reward_sealed_dungeon_tableId() const {return 289;};
BnsTables::Shared::TableRef dungeon_challenge_reward;
int dungeon_challenge_reward_tableId() const {return 351;};
...
int action_name_tableId() const {return 448;};
BnsTables::Shared::TableRef action_desc;
int action_desc_tableId() const {return 448;};
BnsTables::Shared::TableRef manipulate_transit_zone;
int manipulate_transit_zone_tableId() const {return 493;};
...
int loot_quests_tableId() const {return 315;};
...
int loot_item_tableId() const {return 207;};
...
int finish_blow_quests_tableId() const {return 315;};
...
int default_idle_tableId() const {return 287;};
bool warfare_boss;
char Pad16[3];
__int64 max_hp;
__int16 max_sp;
...
int grade_tooltip_text_tableId() const {return 448;};
...
int dying_message_tableId() const {return 448;};
signed char role_type;
char Pad25[3];
BnsTables::Shared::TableRef die_shout;
int die_shout_tableId() const {return 448;};
signed char race_type;
char Pad26[3];
BnsTables::Shared::TableRef indicator;
int indicator_tableId() const {return 196;};
...
int summoned_beauty_shop_tableId() const {return 430;};
...
int map_unit_tableId() const {return 266;};
...
int newbiecare_tableId() const {return 282;};
...
wchar_t* target_icon_imageset;
		...
		static BnsTables::Shared::TableVersion Version() { return BnsTables::Shared::TableVersion(11, 4); }
