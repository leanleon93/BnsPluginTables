...
int title2_tableId() const {return 441;};
...
int store_tableId() const {return 421;};
BnsTables::Shared::TableRef store_by_item;
int store_by_item_tableId() const {return 420;};
BnsTables::Shared::TableRef store2[6];
__int32 store2_Size() const {return 6;};
int store2_tableId() const {return 419;};
...
int personal_dropped_pouch_reward_tableId() const {return 346;};
BnsTables::Shared::TableRef personal_dropped_pouch_event_reward;
int personal_dropped_pouch_event_reward_tableId() const {return 346;};
...
int personal_dropped_pouch_reward_difficulty_type_tableId() const {return 346;};
BnsTables::Shared::TableRef reward_sealed_dungeon;
int reward_sealed_dungeon_tableId() const {return 284;};
BnsTables::Shared::TableRef dungeon_challenge_reward;
int dungeon_challenge_reward_tableId() const {return 346;};
BnsTables::Shared::TableRef fielditemdrop;
int fielditemdrop_tableId() const {return 148;};
BnsTables::Shared::TableRef deadbody_fielditemdrop;
int deadbody_fielditemdrop_tableId() const {return 148;};
...
int action_name_tableId() const {return 441;};
...
int manipulate_transit_zone_tableId() const {return 486;};
...
int loot_quests_tableId() const {return 310;};
...
int loot_item_tableId() const {return 204;};
...
int finish_blow_quests_tableId() const {return 310;};
...
int default_idle_tableId() const {return 282;};
bool warfare_boss;
char Pad16[3];
__int64 max_hp;
__int16 max_sp;
...
int grade_tooltip_text_tableId() const {return 441;};
...
int boss_spawn_message_tableId() const {return 161;};
...
int end_talk_social_tableId() const {return 403;};
...
int dying_message_tableId() const {return 441;};
signed char role_type;
char Pad25[3];
BnsTables::Shared::TableRef die_shout;
int die_shout_tableId() const {return 441;};
signed char race_type;
char Pad26[3];
BnsTables::Shared::TableRef indicator;
int indicator_tableId() const {return 193;};
...
int summoned_beauty_shop_tableId() const {return 423;};
...
int map_unit_tableId() const {return 262;};
...
int newbiecare_tableId() const {return 278;};
