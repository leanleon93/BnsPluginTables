...
int upgrade_grocery_tableId() const {return 232;};
...
int main_ingredient_title_name_tableId() const {return 441;};
BnsTables::Shared::TableRef main_ingredient_title_item;
int main_ingredient_title_item_tableId() const {return 204;};
...
int random_failure_mileage_distribution_type_tableId() const {return 321;};
...
int random_failure_mileage_influence_recipe_tableId() const {return 228;};
BnsTables::Shared::TableRef random_retry_cost;
int random_retry_cost_tableId() const {return 231;};
...
int coupon_item_tableId() const {return 204;};
