...
int upgrade_grocery_tableId() const {return 223;};
...
int main_ingredient_title_name_tableId() const {return 425;};
BnsTables::Shared::TableRef main_ingredient_title_item;
int main_ingredient_title_item_tableId() const {return 197;};
...
int sub_ingredient_title_name_tableId() const {return 425;};
BnsTables::Shared::TableRef sub_ingredient_title_item[7];
__int32 sub_ingredient_title_item_Size() const {return 7;};
int sub_ingredient_title_item_tableId() const {return 197;};
...
int random_failure_mileage_distribution_type_tableId() const {return 309;};
...
int random_failure_mileage_influence_recipe_tableId() const {return 221;};
BnsTables::Shared::TableRef random_retry_cost;
int random_retry_cost_tableId() const {return 222;};
...
int title_item_tableId() const {return 197;};
BnsTables::Shared::TableRef title_name;
int title_name_tableId() const {return 425;};
BnsTables::Shared::TableRef title_reward;
int title_reward_tableId() const {return 308;};
