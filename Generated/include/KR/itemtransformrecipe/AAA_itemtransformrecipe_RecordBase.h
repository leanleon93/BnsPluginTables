...
int upgrade_grocery_tableId(){return 221;};
...
int main_ingredient_title_name_tableId(){return 420;};
BnsTables::Shared::TableRef main_ingredient_title_item;
int main_ingredient_title_item_tableId(){return 195;};
...
int sub_ingredient_title_name_tableId(){return 420;};
BnsTables::Shared::TableRef sub_ingredient_title_item[7];
int sub_ingredient_title_item_tableId(){return 195;};
...
int random_failure_mileage_distribution_type_tableId(){return 304;};
BnsTables::Shared::TableRef random_failure_mileage_influence_recipe[2];
int random_failure_mileage_influence_recipe_tableId(){return 219;};
BnsTables::Shared::TableRef random_retry_cost;
int random_retry_cost_tableId(){return 220;};
