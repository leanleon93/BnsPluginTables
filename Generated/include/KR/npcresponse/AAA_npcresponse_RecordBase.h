...
int talk_message_tableId() const {return 291;};
BnsTables::Shared::TableRef indicator_social;
int indicator_social_tableId() const {return 197;};
BnsTables::Shared::TableRef approach_social;
int approach_social_tableId() const {return 416;};
BnsTables::Shared::TableRef idle;
int idle_tableId() const {return 195;};
bool idle_visible;
char Pad2[3];
BnsTables::Shared::TableRef idle_start;
int idle_start_tableId() const {return 416;};
BnsTables::Shared::TableRef idle_end;
int idle_end_tableId() const {return 416;};
