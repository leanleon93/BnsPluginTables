...
int join_confirm_msg_tableId() const {return 445;};
BnsTables::Shared::TableRef join_confirm_input;
int join_confirm_input_tableId() const {return 445;};
BnsTables::Shared::TableRef transfer_confirm_msg;
int transfer_confirm_msg_tableId() const {return 445;};
BnsTables::Shared::TableRef transfer_confirm_input;
int transfer_confirm_input_tableId() const {return 445;};
BnsTables::Shared::TableRef grade_name;
int grade_name_tableId() const {return 445;};
BnsTables::Shared::TableRef grade_image;
int grade_image_tableId() const {return 445;};
signed char grade_type;
char Pad1[3];
BnsTables::Shared::IconRef grade_icon;
BnsTables::Shared::TableRef grade_tooltip;
int grade_tooltip_tableId() const {return 445;};
BnsTables::Shared::TableRef hide_name;
int hide_name_tableId() const {return 445;};
BnsTables::Shared::TableRef hide_summoned_name;
int hide_summoned_name_tableId() const {return 445;};
BnsTables::Shared::TableRef guild_battle_field_teleport;
int guild_battle_field_teleport_tableId() const {return 441;};
