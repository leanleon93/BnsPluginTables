...
int soul_boost_event_tableId() const {return 407;};
...
int season_name_text_tableId() const {return 444;};
...
int purchase_grade_item_tableId() const {return 205;};
...
int membership_benefit_tableId() const {return 274;};
