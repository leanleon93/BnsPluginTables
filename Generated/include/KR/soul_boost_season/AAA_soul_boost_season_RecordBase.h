...
int soul_boost_event_tableId() const {return 404;};
...
int season_name_text_tableId() const {return 441;};
...
int purchase_grade_item_tableId() const {return 204;};
...
int membership_benefit_tableId() const {return 273;};
