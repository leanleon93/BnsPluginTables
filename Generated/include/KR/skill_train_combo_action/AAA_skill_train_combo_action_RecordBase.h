...
int stance_name_tableId() const {return 448;};
BnsTables::Shared::TableRef buff_name;
int buff_name_tableId() const {return 448;};
BnsTables::Shared::TableRef function_name;
int function_name_tableId() const {return 448;};
BnsTables::Shared::TableRef function_desc;
int function_desc_tableId() const {return 448;};
