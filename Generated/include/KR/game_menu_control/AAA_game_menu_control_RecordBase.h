...
int required_acquired_and_complete_quest_tableId() const {return 312;};
...
int notifycenter_message_tableId() const {return 444;};
BnsTables::Shared::TableRef unavailability_confirm_text;
int unavailability_confirm_text_tableId() const {return 444;};
bool use_record;
