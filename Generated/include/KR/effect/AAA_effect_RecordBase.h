...
int transform_effect_tableId(){return 115;};
__int8 buff_type;
...
int description3_tableId(){return 420;};
...
int description_constellation_tableId(){return 420;};
...
int linker_abnormal_tableId(){return 240;};
BnsTables::Shared::TableRef linkee_abnormal;
int linkee_abnormal_tableId(){return 240;};
...
int attach_notify_message_tableId(){return 155;};
BnsTables::Shared::TableRef description_item_random_option;
int description_item_random_option_tableId(){return 420;};
