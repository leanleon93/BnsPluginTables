...
int season_group_tableId() const {return 331;};
...
int total_season_tableId() const {return 330;};
BnsTables::Shared::TableRef season_schedule[20];
__int32 season_schedule_Size() const {return 20;};
int season_schedule_tableId() const {return 332;};
BnsTables::Shared::TableRef main_season_schedule;
int main_season_schedule_tableId() const {return 332;};
