...
int season_group_tableId() const {return 334;};
...
int name_text_tableId() const {return 445;};
bool job_ranking;
char Pad1[3];
BnsTables::Shared::TableRef total_season;
int total_season_tableId() const {return 333;};
BnsTables::Shared::TableRef season_schedule[20];
__int32 season_schedule_Size() const {return 20;};
int season_schedule_tableId() const {return 335;};
BnsTables::Shared::TableRef main_season_schedule;
int main_season_schedule_tableId() const {return 335;};
