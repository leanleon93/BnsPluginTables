...
int arrow_control_point_tableId() const {return 504;};
BnsTables::Shared::TableRef opening_tip_off_control_point;
int opening_tip_off_control_point_tableId() const {return 504;};
BnsTables::Shared::TableRef alpha_goal_post;
int alpha_goal_post_tableId() const {return 504;};
BnsTables::Shared::TableRef beta_goal_post;
int beta_goal_post_tableId() const {return 504;};
...
int ball_npc_id_tableId() const {return 286;};
