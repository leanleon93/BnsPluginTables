...
int zone_neutral_tableId() const {return 468;};
...
int respawn_confirm_text_tableId() const {return 425;};
BnsTables::Shared::TableRef escape_cave_confirm_text;
int escape_cave_confirm_text_tableId() const {return 425;};
...
int tactic_normal_tableId() const {return 425;};
BnsTables::Shared::TableRef tactic_hard;
int tactic_hard_tableId() const {return 425;};
BnsTables::Shared::TableRef tactic_easy;
int tactic_easy_tableId() const {return 425;};
