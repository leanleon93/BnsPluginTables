...
int zone_neutral_tableId() const {return 480;};
...
int npc_for_step_tableId() const {return 277;};
...
int quest_for_step_tableId() const {return 307;};
...
int dungeon_quest_difficulty_type_tableId() const {return 307;};
...
int tactic_normal_tableId() const {return 435;};
BnsTables::Shared::TableRef tactic_hard;
int tactic_hard_tableId() const {return 435;};
BnsTables::Shared::TableRef tactic_easy;
int tactic_easy_tableId() const {return 435;};
...
int dungeon_challenge_reward_npc_tableId() const {return 277;};
