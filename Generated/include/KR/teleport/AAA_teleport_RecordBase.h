...
int teleport_position_tableId() const {return 504;};
...
int ui_preceding_quest_tableId() const {return 314;};
BnsTables::Shared::TableRef required_quest;
int required_quest_tableId() const {return 314;};
bool capital;
signed char teleport_cost_type;
char Pad2[2];
BnsTables::Shared::TableRef party_chat_channel;
int party_chat_channel_tableId() const {return 292;};
