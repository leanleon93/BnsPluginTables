...
int teleport_position_tableId() const {return 501;};
...
int activated_faction_tableId() const {return 141;};
bool joined_faction;
...
int ui_preceding_quest_tableId() const {return 312;};
...
int party_chat_channel_tableId() const {return 290;};
