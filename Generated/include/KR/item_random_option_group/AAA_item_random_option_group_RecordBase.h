...
int effect_list_tableId() const {return 123;};
...
int skill_build_up_group_list_tableId() const {return 371;};
...
int skill_train_by_item_list_tableId() const {return 399;};
...
int skill_train_by_item_list_title_tableId() const {return 454;};
...
int draw_cost_main_item_tableId() const {return 208;};
...
int draw_cost_sub_item_1_tableId() const {return 208;};
...
int draw_cost_sub_item_2_tableId() const {return 208;};
...
int draw_cost_sub_item_3_tableId() const {return 208;};
...
int draw_cost_sub_item_4_tableId() const {return 208;};
