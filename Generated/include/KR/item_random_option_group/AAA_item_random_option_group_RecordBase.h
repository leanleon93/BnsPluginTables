...
int effect_list_tableId() const {return 121;};
...
int skill_build_up_group_list_tableId() const {return 365;};
...
int skill_train_by_item_list_tableId() const {return 391;};
...
int skill_train_by_item_list_title_tableId() const {return 444;};
...
int draw_cost_main_item_tableId() const {return 205;};
...
int draw_cost_sub_item_1_tableId() const {return 205;};
...
int draw_cost_sub_item_2_tableId() const {return 205;};
...
int draw_cost_sub_item_3_tableId() const {return 205;};
...
int draw_cost_sub_item_4_tableId() const {return 205;};
