...
int effect_list_tableId() const {return 122;};
...
int skill_build_up_group_list_tableId() const {return 366;};
...
int skill_train_by_item_list_tableId() const {return 392;};
...
int skill_train_by_item_list_title_tableId() const {return 445;};
...
int draw_cost_main_item_tableId() const {return 206;};
...
int draw_cost_sub_item_1_tableId() const {return 206;};
...
int draw_cost_sub_item_2_tableId() const {return 206;};
...
int draw_cost_sub_item_3_tableId() const {return 206;};
...
int draw_cost_sub_item_4_tableId() const {return 206;};
