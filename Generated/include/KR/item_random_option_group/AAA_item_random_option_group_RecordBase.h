...
int skill_build_up_group_list_tableId() const {return 363;};
...
int skill_train_by_item_list_tableId() const {return 388;};
...
int skill_train_by_item_list_title_tableId() const {return 441;};
