...
int manipulate_zone_env2_list_tableId() const {return 469;};
BnsTables::Shared::TableRef name2;
int name2_tableId() const {return 425;};
BnsTables::Shared::TableRef nickname;
int nickname_tableId() const {return 425;};
...
int description7_tableId() const {return 425;};
...
int identify_main_info_tableId() const {return 425;};
BnsTables::Shared::TableRef identify_sub_info;
int identify_sub_info_tableId() const {return 425;};
BnsTables::Shared::TableRef identify_description;
int identify_description_tableId() const {return 425;};
BnsTables::Shared::TableRef legend_transform_title_name;
int legend_transform_title_name_tableId() const {return 425;};
