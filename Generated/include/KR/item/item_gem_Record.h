...
int reveal_consumable_item_tableId() const {return 195;};
...
int attach_equip_gem_piece_consumable_item_tableId() const {return 195;};
...
int main_ability_fixed_tableId() const {return 211;};
BnsTables::Shared::TableRef sub_ability_fixed;
int sub_ability_fixed_tableId() const {return 211;};
...
int sub_ability_random_tableId() const {return 211;};
BnsTables::Shared::TableRef feed_ability_random[8];
__int32 feed_ability_random_Size() const {return 8;};
int feed_ability_random_tableId() const {return 211;};
...
int ability_feeding_required_item_tableId() const {return 195;};
...
int ability_feeding_special_item_tableId() const {return 195;};
...
int ability_feeding_target_tableId() const {return 189;};
BnsTables::Shared::TableRef skill_by_equipment;
int skill_by_equipment_tableId() const {return 343;};
...
int unseal_consume_item2_tableId() const {return 195;};
