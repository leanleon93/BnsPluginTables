...
int reveal_consumable_item_tableId() const {return 204;};
...
int equip_gem_piece_tableId() const {return 127;};
...
int attach_equip_gem_piece_consumable_item_tableId() const {return 204;};
...
int attach_equip_gem_piece_tableId() const {return 127;};
...
int attack_effect_tableId() const {return 119;};
...
int second_attack_effect_tableId() const {return 119;};
...
int main_ability_fixed_tableId() const {return 220;};
BnsTables::Shared::TableRef sub_ability_fixed;
int sub_ability_fixed_tableId() const {return 220;};
...
int sub_ability_random_tableId() const {return 220;};
BnsTables::Shared::TableRef feed_ability_random[8];
__int32 feed_ability_random_Size() const {return 8;};
int feed_ability_random_tableId() const {return 220;};
...
int ability_feeding_required_item_tableId() const {return 204;};
...
int ability_feeding_special_item_tableId() const {return 204;};
...
int ability_feeding_target_tableId() const {return 197;};
BnsTables::Shared::TableRef skill_by_equipment;
int skill_by_equipment_tableId() const {return 364;};
__int16 hidden_power_attach;
char Pad_sub_8[2];
BnsTables::Shared::TableRef weapon_soul_gem_pet;
int weapon_soul_gem_pet_tableId() const {return 301;};
BnsTables::Shared::TableRef unseal_consume_item2[4];
__int32 unseal_consume_item2_Size() const {return 4;};
int unseal_consume_item2_tableId() const {return 204;};
...
int sub_ability_random_draw_cost_tableId() const {return 80;};
