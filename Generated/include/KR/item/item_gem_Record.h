...
int reveal_consumable_item_tableId() const {return 207;};
...
int equip_gem_piece_tableId() const {return 129;};
...
int attach_equip_gem_piece_consumable_item_tableId() const {return 207;};
...
int attach_equip_gem_piece_tableId() const {return 129;};
...
int attack_effect_tableId() const {return 121;};
...
int second_attack_effect_tableId() const {return 121;};
...
int main_ability_fixed_tableId() const {return 223;};
BnsTables::Shared::TableRef sub_ability_fixed;
int sub_ability_fixed_tableId() const {return 223;};
...
int sub_ability_random_tableId() const {return 223;};
BnsTables::Shared::TableRef feed_ability_random[8];
__int32 feed_ability_random_Size() const {return 8;};
int feed_ability_random_tableId() const {return 223;};
...
int ability_feeding_required_item_tableId() const {return 207;};
...
int ability_feeding_special_item_tableId() const {return 207;};
...
int sub_ability_random_draw_cost_tableId() const {return 82;};
