...
int identify_grocery_tableId() const {return 204;};
...
int open_gem_slot_grocery_tableId() const {return 204;};
...
int ui_repair_item_tableId() const {return 204;};
...
int pet_tableId() const {return 301;};
__int32 closet_group_id;
BnsTables::Shared::TableRef skill_skin;
int skill_skin_tableId() const {return 378;};
...
int init_star_stone_slot_cost_group_tableId() const {return 80;};
BnsTables::Shared::TableRef star_stone_slot_expansion_cost[9];
__int32 star_stone_slot_expansion_cost_Size() const {return 9;};
int star_stone_slot_expansion_cost_tableId() const {return 80;};
