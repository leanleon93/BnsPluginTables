...
int ui_repair_item_tableId(){return 195;};
...
int pet_tableId(){return 285;};
__int32 closet_group_id;
BnsTables::Shared::TableRef skill_skin;
int skill_skin_tableId(){return 357;};
...
__int8 soul_gem_slot_probability;
