...
int identify_grocery_tableId() const {return 205;};
...
int open_gem_slot_grocery_tableId() const {return 205;};
...
int ui_repair_item_tableId() const {return 205;};
...
int pet_tableId() const {return 303;};
__int32 closet_group_id;
BnsTables::Shared::TableRef skill_skin;
int skill_skin_tableId() const {return 381;};
