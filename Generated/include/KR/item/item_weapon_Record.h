...
int identify_grocery_tableId() const {return 195;};
...
int open_gem_slot_grocery_tableId() const {return 195;};
...
int ui_repair_item_tableId() const {return 195;};
...
int pet_tableId() const {return 285;};
