...
int duel_skill3_tableId() const {return 359;};
...
int skill_limit_faction_tableId() const {return 142;};
__int16 skill_limit_faction_level;
char Pad_sub_3[2];
BnsTables::Shared::TableRef skill_limit_activated_faction;
int skill_limit_activated_faction_tableId() const {return 142;};
...
int skill_skin_acquire_tableId() const {return 382;};
BnsTables::Shared::TableRef resurrect_effect;
int resurrect_effect_tableId() const {return 120;};
__int32 bonus_exp;
...
int bonus_sealed_dungeon_id_tableId() const {return 119;};
...
int valid_attraction_name_tableId() const {return 445;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 490;};
...
int unseal_acquire_item_tableId() const {return 206;};
...
int unseal_result_preview_item_tableId() const {return 206;};
...
int skill_train_by_item_for_transmit_tableId() const {return 391;};
BnsTables::Shared::TableRef decompose_random_box_replaced_by_decompose_item;
int decompose_random_box_replaced_by_decompose_item_tableId() const {return 206;};
...
int reinforce_skill_train_by_item_extract_next_item_tableId() const {return 206;};
BnsTables::Shared::TableRef reinforce_skill_train_by_item_extract_prev_item;
int reinforce_skill_train_by_item_extract_prev_item_tableId() const {return 206;};
