...
int duel_skill3_tableId() const {return 361;};
...
int skill_skin_acquire_tableId() const {return 385;};
...
int valid_attraction_name_tableId() const {return 448;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 493;};
...
int slate_scroll_tableId() const {return 406;};
...
int card_tableId() const {return 477;};
...
int skill_train_by_item_for_transmit_tableId() const {return 394;};
