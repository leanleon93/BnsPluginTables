...
int duel_skill3_tableId() const {return 358;};
...
int skill_limit_faction_tableId() const {return 141;};
__int16 skill_limit_faction_level;
char Pad_sub_3[2];
BnsTables::Shared::TableRef skill_limit_activated_faction;
int skill_limit_activated_faction_tableId() const {return 141;};
...
int skill_skin_acquire_tableId() const {return 381;};
...
int valid_attraction_name_tableId() const {return 444;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 489;};
...
int unseal_acquire_item_tableId() const {return 205;};
...
int unseal_result_preview_item_tableId() const {return 205;};
...
int skill_train_by_item_for_transmit_tableId() const {return 390;};
BnsTables::Shared::TableRef decompose_random_box_replaced_by_decompose_item;
int decompose_random_box_replaced_by_decompose_item_tableId() const {return 205;};
...
int reinforce_skill_train_by_item_extract_next_item_tableId() const {return 205;};
BnsTables::Shared::TableRef reinforce_skill_train_by_item_extract_prev_item;
int reinforce_skill_train_by_item_extract_prev_item_tableId() const {return 205;};
