...
int duel_skill3_tableId() const {return 360;};
...
int skill_skin_acquire_tableId() const {return 384;};
...
int valid_attraction_name_tableId() const {return 447;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 492;};
...
int unseal_acquire_item_tableId() const {return 207;};
...
int unseal_result_preview_item_tableId() const {return 207;};
...
int slate_scroll_tableId() const {return 405;};
...
int skill_train_by_item_for_transmit_tableId() const {return 393;};
BnsTables::Shared::TableRef decompose_random_box_replaced_by_decompose_item;
int decompose_random_box_replaced_by_decompose_item_tableId() const {return 207;};
