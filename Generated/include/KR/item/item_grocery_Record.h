...
int duel_skill3_tableId() const {return 341;};
...
int skill_skin_acquire_tableId() const {return 362;};
...
int valid_attraction_name_tableId() const {return 425;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 468;};
...
int unseal_acquire_item_tableId() const {return 197;};
...
int unseal_result_preview_item_tableId() const {return 197;};
...
int slate_scroll_tableId() const {return 383;};
...
int card_tableId() const {return 454;};
...
int skill_train_by_item_for_transmit_tableId() const {return 371;};
BnsTables::Shared::TableRef decompose_random_box_replaced_by_decompose_item;
int decompose_random_box_replaced_by_decompose_item_tableId() const {return 197;};
