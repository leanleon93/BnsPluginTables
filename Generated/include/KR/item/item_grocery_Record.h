...
int duel_skill3_tableId() const {return 356;};
...
int skill_skin_acquire_tableId() const {return 378;};
...
int valid_attraction_name_tableId() const {return 441;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 486;};
...
int unseal_acquire_item_tableId() const {return 204;};
...
int unseal_result_preview_item_tableId() const {return 204;};
...
int slate_scroll_tableId() const {return 399;};
...
int skill_train_by_item_for_transmit_tableId() const {return 387;};
BnsTables::Shared::TableRef decompose_random_box_replaced_by_decompose_item;
int decompose_random_box_replaced_by_decompose_item_tableId() const {return 204;};
...
int reinforce_skill_train_by_item_extract_next_item_tableId() const {return 204;};
BnsTables::Shared::TableRef reinforce_skill_train_by_item_extract_prev_item;
int reinforce_skill_train_by_item_extract_prev_item_tableId() const {return 204;};
