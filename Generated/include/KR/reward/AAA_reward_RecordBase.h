...
int fixed_item_tableId() const {return 205;};
...
int group_1_item_tableId() const {return 205;};
...
int group_2_item_tableId() const {return 205;};
...
int group_3_item_tableId() const {return 205;};
...
int group_4_item_tableId() const {return 205;};
...
int group_5_item_tableId() const {return 205;};
...
int rare_item_tableId() const {return 205;};
...
int selected_item_tableId() const {return 205;};
...
int smart_group_1_reward_tableId() const {return 405;};
...
int smart_group_2_reward_tableId() const {return 405;};
...
int smart_group_3_reward_tableId() const {return 405;};
...
int smart_group_4_reward_tableId() const {return 405;};
...
int smart_group_5_reward_tableId() const {return 405;};
...
int smart_rare_reward_tableId() const {return 405;};
