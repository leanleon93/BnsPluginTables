...
int acquire_quest_tableId() const {return 312;};
...
int target_first_filter_tableId() const {return 152;};
BnsTables::Shared::TableRef target_second_filter[4];
__int32 target_second_filter_Size() const {return 4;};
int target_second_filter_tableId() const {return 152;};
...
int moveanim_tableId() const {return 150;};
wchar_t* grab_bone;
wchar_t* pick_up;
wchar_t* put_down;
wchar_t* throw_item;
...
int drop_action_name_tableId() const {return 444;};
BnsTables::Shared::TableRef drop_action_desc;
int drop_action_desc_tableId() const {return 444;};
