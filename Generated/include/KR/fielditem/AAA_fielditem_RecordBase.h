...
int acquire_quest_tableId() const {return 318;};
...
int drop_action_name_tableId() const {return 454;};
BnsTables::Shared::TableRef drop_action_desc;
int drop_action_desc_tableId() const {return 454;};
