...
int invoke_effect_tableId() const {return 121;};
...
int moveanim_tableId() const {return 152;};
wchar_t* grab_bone;
wchar_t* pick_up;
wchar_t* put_down;
wchar_t* throw_item;
...
int drop_action_name_tableId() const {return 447;};
BnsTables::Shared::TableRef drop_action_desc;
int drop_action_desc_tableId() const {return 447;};
