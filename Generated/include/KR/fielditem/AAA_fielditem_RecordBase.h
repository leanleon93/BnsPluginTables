...
int equip_effect_tableId(){return 115;};
bool not_change_create_pos;
__int8 parry_event;
char Pad1[2];
BnsTables::Shared::TableRef acquire_quest;
int acquire_quest_tableId(){return 294;};
...
int use_skill3_tableId(){return 337;};
__int16 consume_use_count[4];
BnsTables::Shared::TableRef throw_skill3;
int throw_skill3_tableId(){return 337;};
bool init_activated;
char Pad4[3];
...
int moveanim_tableId(){return 144;};
wchar_t* grab_bone;
wchar_t* pick_up;
wchar_t* put_down;
wchar_t* throw_item;
...
int drop_action_name_tableId(){return 420;};
BnsTables::Shared::TableRef drop_action_desc;
int drop_action_desc_tableId(){return 420;};
