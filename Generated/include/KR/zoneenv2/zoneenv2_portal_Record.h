...
int transit_pc_spawn_in_arena_tableId() const {return 488;};
...
int transit_leave_social_tableId() const {return 396;};
BnsTables::Shared::TableRef transit_enter_social;
int transit_enter_social_tableId() const {return 396;};
