...
int transit_zone_tableId() const {return 468;};
...
int transit_pc_spawn_in_arena_tableId() const {return 477;};
...
int transit_leave_social_tableId() const {return 387;};
BnsTables::Shared::TableRef transit_enter_social;
int transit_enter_social_tableId() const {return 387;};
