...
int transit_zone_tableId() const {return 483;};
...
int transit_pc_spawn_in_arena_tableId() const {return 492;};
...
int transit_leave_social_tableId() const {return 400;};
BnsTables::Shared::TableRef transit_enter_social;
int transit_enter_social_tableId() const {return 400;};
