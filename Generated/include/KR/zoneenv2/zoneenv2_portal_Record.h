...
int transit_zone_tableId() const {return 501;};
...
int transit_pc_spawn_in_arena_tableId() const {return 510;};
...
int transit_leave_social_tableId() const {return 416;};
BnsTables::Shared::TableRef transit_enter_social;
int transit_enter_social_tableId() const {return 416;};
