...
int occupy_action_name_tableId() const {return 441;};
...
int try_refine_action_name_tableId() const {return 441;};
...
int give_score_action_name_tableId() const {return 441;};
BnsTables::Shared::TableRef give_score_social;
int give_score_social_tableId() const {return 403;};
...
int accroach_action_name_tableId() const {return 441;};
