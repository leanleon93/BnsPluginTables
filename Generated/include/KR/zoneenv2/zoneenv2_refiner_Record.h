...
int refined_reward_item_tableId() const {return 205;};
...
int occupy_action_name_tableId() const {return 444;};
...
int try_refine_action_name_tableId() const {return 444;};
...
int give_score_action_name_tableId() const {return 444;};
BnsTables::Shared::TableRef give_score_social;
int give_score_social_tableId() const {return 406;};
...
int accroach_action_name_tableId() const {return 444;};
