...
int occupy_action_name_tableId(){return 420;};
...
int try_refine_action_name_tableId(){return 420;};
...
int give_score_action_name_tableId(){return 420;};
BnsTables::Shared::TableRef give_score_social;
int give_score_social_tableId(){return 382;};
...
int accroach_action_name_tableId(){return 420;};
