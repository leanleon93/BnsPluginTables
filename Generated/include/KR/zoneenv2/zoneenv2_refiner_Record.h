...
int occupy_action_name_tableId() const {return 425;};
...
int try_refine_action_name_tableId() const {return 425;};
...
int give_score_action_name_tableId() const {return 425;};
BnsTables::Shared::TableRef give_score_social;
int give_score_social_tableId() const {return 387;};
...
int accroach_action_name_tableId() const {return 425;};
