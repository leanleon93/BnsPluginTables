...
int refined_reward_item_tableId() const {return 208;};
...
int occupy_action_name_tableId() const {return 454;};
...
int try_refine_action_name_tableId() const {return 454;};
...
int give_score_action_name_tableId() const {return 454;};
BnsTables::Shared::TableRef give_score_social;
int give_score_social_tableId() const {return 416;};
...
int accroach_action_name_tableId() const {return 454;};
