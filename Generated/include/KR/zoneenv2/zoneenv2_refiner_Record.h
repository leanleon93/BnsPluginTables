...
int occupy_action_name_tableId() const {return 435;};
...
int try_refine_action_name_tableId() const {return 435;};
...
int give_score_action_name_tableId() const {return 435;};
BnsTables::Shared::TableRef give_score_social;
int give_score_social_tableId() const {return 397;};
...
int accroach_action_name_tableId() const {return 435;};
