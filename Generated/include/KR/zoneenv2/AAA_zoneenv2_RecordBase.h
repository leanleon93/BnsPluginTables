...
int required_fielditem_tableId() const {return 148;};
BnsTables::Shared::TableRef manipulate_by_item;
int manipulate_by_item_tableId() const {return 205;};
...
int required_activated_faction_tableId() const {return 141;};
...
int action_name2_tableId() const {return 444;};
BnsTables::Shared::TableRef action_desc2;
int action_desc2_tableId() const {return 444;};
bool hide_close;
bool hide_empty;
bool tooltip_option;
...
int image_text_tableId() const {return 444;};
