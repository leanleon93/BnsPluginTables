...
int action_name2_tableId() const {return 448;};
BnsTables::Shared::TableRef action_desc2;
int action_desc2_tableId() const {return 448;};
bool hide_close;
bool hide_empty;
bool tooltip_option;
...
int image_text_tableId() const {return 448;};
