...
int manipulate_by_item_tableId() const {return 204;};
...
int action_name2_tableId() const {return 441;};
BnsTables::Shared::TableRef action_desc2;
int action_desc2_tableId() const {return 441;};
bool hide_close;
bool hide_empty;
bool tooltip_option;
...
int image_text_tableId() const {return 441;};
