...
int survey_question_tableId() const {return 447;};
signed char job;
signed char race;
char Pad0[2];
__int32 level;
BnsTables::Shared::TableRef completed_quest;
int completed_quest_tableId() const {return 318;};
__int16 start_year;
...
int optional_reward_item_tableId() const {return 208;};
