...
int survey_question_tableId(){return 413;};
__int8 job;
__int8 race;
char Pad0[2];
__int32 level;
BnsTables::Shared::TableRef completed_quest;
int completed_quest_tableId(){return 294;};
__int16 start_year;
__int8 start_month;
__int8 start_day;
__int8 start_hour;
