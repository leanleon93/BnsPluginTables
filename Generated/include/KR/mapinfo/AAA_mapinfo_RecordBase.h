...
int parent_mapinfo_tableId(){return 247;};
float scale;
...
int map_group_2_tableId(){return 246;};
float local_axis_x;
float local_axis_y;
__int16 image_size;
char Pad0[2];
