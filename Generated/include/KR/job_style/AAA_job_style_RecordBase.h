...
int sp2_tooltip_name_tableId() const {return 447;};
wchar_t* introduce_job_style_icon;
BnsTables::Shared::TableRef introduce_job_style_name;
int introduce_job_style_name_tableId() const {return 447;};
BnsTables::Shared::TableRef introduce_job_style_play_desc;
int introduce_job_style_play_desc_tableId() const {return 447;};
...
int introduce_job_style_specialization_tableId() const {return 248;};
