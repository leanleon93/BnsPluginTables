...
int sp2_tooltip_name_tableId() const {return 445;};
wchar_t* introduce_job_style_icon;
BnsTables::Shared::TableRef introduce_job_style_name;
int introduce_job_style_name_tableId() const {return 445;};
BnsTables::Shared::TableRef introduce_job_style_play_desc;
int introduce_job_style_play_desc_tableId() const {return 445;};
...
int introduce_job_style_specialization_tableId() const {return 247;};
