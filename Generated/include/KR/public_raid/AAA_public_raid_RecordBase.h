...
int start_weekly_time_tableId() const {return 464;};
...
int publicraid_name2_tableId() const {return 438;};
BnsTables::Shared::TableRef publicraid_desc;
int publicraid_desc_tableId() const {return 438;};
...
int public_raid_npc_for_kismet_tableId() const {return 279;};
