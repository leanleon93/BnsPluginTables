...
int start_weekly_time_tableId() const {return 467;};
...
int enter_pc_spawn_tableId() const {return 495;};
BnsTables::Shared::TableRef publicraid_name2;
int publicraid_name2_tableId() const {return 441;};
BnsTables::Shared::TableRef publicraid_desc;
int publicraid_desc_tableId() const {return 441;};
...
int public_raid_npc_for_kismet_tableId() const {return 280;};
