...
int required_available_weekly_time_tableId() const {return 482;};
BnsTables::Shared::TableRef start_weekly_time;
int start_weekly_time_tableId() const {return 482;};
...
int enter_pc_spawn_tableId() const {return 510;};
BnsTables::Shared::TableRef publicraid_name2;
int publicraid_name2_tableId() const {return 454;};
BnsTables::Shared::TableRef publicraid_desc;
int publicraid_desc_tableId() const {return 454;};
...
int public_raid_npc_for_kismet_tableId() const {return 286;};
