...
int start_gamemessage_tableId(){return 155;};
BnsTables::Shared::TableRef start_gamemessage_remain;
int start_gamemessage_remain_tableId(){return 155;};
BnsTables::Shared::TableRef end_gamemessage;
int end_gamemessage_tableId(){return 155;};
BnsTables::Shared::TableRef end_gamemessage_remain;
int end_gamemessage_remain_tableId(){return 155;};
BnsTables::Shared::TableRef clock_alarm_desc_start;
int clock_alarm_desc_start_tableId(){return 420;};
BnsTables::Shared::TableRef clock_alarm_desc_progressing;
int clock_alarm_desc_progressing_tableId(){return 420;};
BnsTables::Shared::TableRef clock_alarm_desc_end;
int clock_alarm_desc_end_tableId(){return 420;};
