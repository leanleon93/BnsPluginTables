...
int weekly_time_table_tableId() const {return 467;};
signed char alarm_type;
char Pad0[3];
BnsTables::Shared::TableRef start_gamemessage;
int start_gamemessage_tableId() const {return 161;};
BnsTables::Shared::TableRef start_gamemessage_remain;
int start_gamemessage_remain_tableId() const {return 161;};
BnsTables::Shared::TableRef end_gamemessage;
int end_gamemessage_tableId() const {return 161;};
BnsTables::Shared::TableRef end_gamemessage_remain;
int end_gamemessage_remain_tableId() const {return 161;};
BnsTables::Shared::TableRef clock_alarm_desc_start;
int clock_alarm_desc_start_tableId() const {return 441;};
BnsTables::Shared::TableRef clock_alarm_desc_progressing;
int clock_alarm_desc_progressing_tableId() const {return 441;};
BnsTables::Shared::TableRef clock_alarm_desc_end;
int clock_alarm_desc_end_tableId() const {return 441;};
BnsTables::Shared::TableRef name2;
int name2_tableId() const {return 441;};
BnsTables::Shared::TableRef hud_icon_tooltip_desc;
int hud_icon_tooltip_desc_tableId() const {return 441;};
