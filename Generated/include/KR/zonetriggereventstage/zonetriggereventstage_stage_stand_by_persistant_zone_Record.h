...
int event_channel_text_tableId(){return 420;};
BnsTables::Shared::TableRef event_notify_diff_zone[6];
int event_notify_diff_zone_tableId(){return 461;};
BnsTables::Shared::TableRef event_notify_diff_zone_msg;
int event_notify_diff_zone_msg_tableId(){return 155;};
BnsTables::Shared::TableRef event_notify_diff_channel_msg;
int event_notify_diff_channel_msg_tableId(){return 155;};
BnsTables::Shared::TableRef event_notify_msg;
int event_notify_msg_tableId(){return 155;};
