...
int parent_skill_tableId() const {return 359;};
BnsTables::Shared::TableRef base_skill;
int base_skill_tableId() const {return 359;};
BnsTables::Shared::TableRef change_skill[4];
__int32 change_skill_Size() const {return 4;};
int change_skill_tableId() const {return 359;};
signed char row;
signed char column;
signed char job;
...
int base_skill_acquire_route_tableId() const {return 225;};
BnsTables::Shared::TableRef change_skill_acquire_route[4];
__int32 change_skill_acquire_route_Size() const {return 4;};
int change_skill_acquire_route_tableId() const {return 225;};
