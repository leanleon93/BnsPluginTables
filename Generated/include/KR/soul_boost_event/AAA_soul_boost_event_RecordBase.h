...
int event_name_text_tableId() const {return 447;};
wchar_t* event_name;
...
int bm_exchange_reward_item_tableId() const {return 207;};
...
int bm_accumulate_reward_item_tableId() const {return 207;};
...
int bm_activate_item_tableId() const {return 207;};
