...
int event_name_text_tableId(){return 420;};
wchar_t* event_name;
...
int bm_exchange_reward_item_tableId(){return 195;};
...
int bm_accumulate_reward_item_tableId(){return 195;};
...
int bm_activate_item_tableId(){return 195;};
...
int core_reward_item_tableId(){return 195;};
bool purchase_grade;
