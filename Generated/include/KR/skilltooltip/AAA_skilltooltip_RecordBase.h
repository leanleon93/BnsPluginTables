...
int skill_tableId() const {return 353;};
...
int item_default_text_tableId() const {return 438;};
BnsTables::Shared::TableRef item_replace_text;
int item_replace_text_tableId() const {return 438;};
