...
int item_default_text_tableId() const {return 441;};
BnsTables::Shared::TableRef item_replace_text;
int item_replace_text_tableId() const {return 441;};
