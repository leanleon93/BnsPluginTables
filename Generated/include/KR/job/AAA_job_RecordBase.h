...
int item_map_job_icon_tableId(){return 420;};
BnsTables::Shared::TableRef item_map_job_style_icon[3];
int item_map_job_style_icon_tableId(){return 420;};
...
int contents_journal_job_style_icon_tableId(){return 420;};
