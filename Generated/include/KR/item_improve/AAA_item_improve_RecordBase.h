...
int cost_main_item_tableId() const {return 198;};
...
int cost_sub_item_1_tableId() const {return 198;};
...
int cost_sub_item_2_tableId() const {return 198;};
...
int cost_sub_item_3_tableId() const {return 198;};
...
int cost_sub_item_4_tableId() const {return 198;};
...
int cost_sub_item_5_tableId() const {return 198;};
...
int mileage_random_distribution_tableId() const {return 310;};
