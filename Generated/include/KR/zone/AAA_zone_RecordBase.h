...
int respawn_tableId() const {return 500;};
...
int respawn_by_activated_faction_required_faction_tableId() const {return 142;};
BnsTables::Shared::TableRef respawn_by_activated_faction[2];
__int32 respawn_by_activated_faction_Size() const {return 2;};
int respawn_by_activated_faction_tableId() const {return 500;};
BnsTables::Shared::TableRef basecamp;
int basecamp_tableId() const {return 485;};
...
int reentrance_pcspawn_tableId() const {return 499;};
BnsTables::Shared::TableRef reentrance_pcspawn_in_arena;
int reentrance_pcspawn_in_arena_tableId() const {return 499;};
BnsTables::Shared::TableRef sealed_dungeon_reentrance_pcspawn_in_arena;
int sealed_dungeon_reentrance_pcspawn_in_arena_tableId() const {return 499;};
bool use_zone_exit;
char Pad4[3];
BnsTables::Shared::TableRef map;
int map_tableId() const {return 262;};
BnsTables::Shared::TableRef area;
int area_tableId() const {return 258;};
...
int phase_quest_tableId() const {return 313;};
...
int phase_zone_tableId() const {return 490;};
...
int phase_main_zone_tableId() const {return 490;};
