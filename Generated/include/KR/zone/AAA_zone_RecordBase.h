...
int transfer_pcspawn_by_deprecated_tableId() const {return 498;};
BnsTables::Shared::TableRef chat_channel;
int chat_channel_tableId() const {return 421;};
...
int respawn_tableId() const {return 499;};
...
int respawn_by_activated_faction_required_faction_tableId() const {return 141;};
BnsTables::Shared::TableRef respawn_by_activated_faction[2];
__int32 respawn_by_activated_faction_Size() const {return 2;};
int respawn_by_activated_faction_tableId() const {return 499;};
BnsTables::Shared::TableRef basecamp;
int basecamp_tableId() const {return 484;};
...
int reentrance_pcspawn_tableId() const {return 498;};
BnsTables::Shared::TableRef reentrance_pcspawn_in_arena;
int reentrance_pcspawn_in_arena_tableId() const {return 498;};
BnsTables::Shared::TableRef sealed_dungeon_reentrance_pcspawn_in_arena;
int sealed_dungeon_reentrance_pcspawn_in_arena_tableId() const {return 498;};
bool use_zone_exit;
char Pad4[3];
BnsTables::Shared::TableRef map;
int map_tableId() const {return 261;};
BnsTables::Shared::TableRef area;
int area_tableId() const {return 257;};
...
int phase_quest_tableId() const {return 312;};
...
int phase_zone_tableId() const {return 489;};
...
int phase_main_zone_tableId() const {return 489;};
