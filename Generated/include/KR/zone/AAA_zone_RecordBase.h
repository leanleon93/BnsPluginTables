...
int transfer_pcspawn_by_deprecated_tableId() const {return 510;};
BnsTables::Shared::TableRef chat_channel;
int chat_channel_tableId() const {return 431;};
...
int respawn_tableId() const {return 511;};
...
int respawn_by_activated_faction_tableId() const {return 511;};
...
int reentrance_pcspawn_tableId() const {return 510;};
BnsTables::Shared::TableRef reentrance_pcspawn_in_arena;
int reentrance_pcspawn_in_arena_tableId() const {return 510;};
BnsTables::Shared::TableRef sealed_dungeon_reentrance_pcspawn_in_arena;
int sealed_dungeon_reentrance_pcspawn_in_arena_tableId() const {return 510;};
bool use_zone_exit;
char Pad4[3];
BnsTables::Shared::TableRef map;
int map_tableId() const {return 265;};
BnsTables::Shared::TableRef area;
int area_tableId() const {return 261;};
...
int phase_quest_tableId() const {return 318;};
...
int phase_zone_tableId() const {return 501;};
...
int phase_main_zone_tableId() const {return 501;};
