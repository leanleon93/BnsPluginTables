...
int transfer_pcspawn_by_deprecated_tableId(){return 470;};
BnsTables::Shared::TableRef chat_channel;
int chat_channel_tableId(){return 397;};
__int8 zone_type2;
char Pad1[3];
...
int respawn_tableId(){return 471;};
BnsTables::Shared::TableRef respawn_by_activated_faction_required_faction[2];
int respawn_by_activated_faction_required_faction_tableId(){return 135;};
BnsTables::Shared::TableRef respawn_by_activated_faction[2];
int respawn_by_activated_faction_tableId(){return 471;};
BnsTables::Shared::TableRef basecamp;
int basecamp_tableId(){return 457;};
...
int reentrance_pcspawn_tableId(){return 470;};
BnsTables::Shared::TableRef reentrance_pcspawn_in_arena;
int reentrance_pcspawn_in_arena_tableId(){return 470;};
BnsTables::Shared::TableRef sealed_dungeon_reentrance_pcspawn_in_arena;
int sealed_dungeon_reentrance_pcspawn_in_arena_tableId(){return 470;};
bool use_zone_exit;
char Pad4[3];
BnsTables::Shared::TableRef map;
int map_tableId(){return 247;};
BnsTables::Shared::TableRef area;
int area_tableId(){return 243;};
