...
int success_caster_filter_tableId() const {return 153;};
...
int fail_caster_filter_tableId() const {return 153;};
...
int success_target_filter_tableId() const {return 153;};
...
int fail_target_filter_tableId() const {return 153;};
...
int gather_range_tableId() const {return 374;};
...
int soul_mask_tableId() const {return 414;};
