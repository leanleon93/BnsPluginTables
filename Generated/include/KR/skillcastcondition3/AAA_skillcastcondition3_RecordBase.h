...
int success_caster_filter_tableId() const {return 151;};
...
int fail_caster_filter_tableId() const {return 151;};
...
int success_target_filter_tableId() const {return 151;};
...
int fail_target_filter_tableId() const {return 151;};
...
int gather_range_tableId() const {return 367;};
...
int soul_mask_tableId() const {return 407;};
