...
int success_caster_filter_tableId() const {return 152;};
...
int fail_caster_filter_tableId() const {return 152;};
...
int success_target_filter_tableId() const {return 152;};
...
int fail_target_filter_tableId() const {return 152;};
...
int gather_range_tableId() const {return 373;};
...
int soul_mask_tableId() const {return 413;};
