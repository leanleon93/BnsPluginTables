...
int success_caster_filter_tableId(){return 146;};
__int8 success_caster_filter_op;
char Pad4[3];
BnsTables::Shared::TableRef fail_caster_filter[2];
int fail_caster_filter_tableId(){return 146;};
...
int success_target_filter_tableId(){return 146;};
__int8 success_target_filter_op;
char Pad9[3];
BnsTables::Shared::TableRef fail_target_filter[2];
int fail_target_filter_tableId(){return 146;};
...
int gather_range_tableId(){return 349;};
...
int soul_mask_tableId(){return 389;};
