...
int reset_item_tableId() const {return 203;};
...
int dungeon_tap_name2_tableId() const {return 438;};
BnsTables::Shared::TableRef step_name2[9];
__int32 step_name2_Size() const {return 9;};
int step_name2_tableId() const {return 438;};
...
int raid_dungeon_desc_tableId() const {return 438;};
