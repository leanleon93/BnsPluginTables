...
int random_item_tooltip_text_tableId() const {return 444;};
...
int paid_fixed_item_tableId() const {return 205;};
...
int paid_random_item_tableId() const {return 205;};
...
int paid_random_item_tooltip_text_tableId() const {return 444;};
