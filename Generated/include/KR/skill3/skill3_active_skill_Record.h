...
int dash_attribute_tableId(){return 347;};
bool sit_down;
__int8 hostile_type;
char Pad_sub_1[2];
BnsTables::Shared::TableRef target_filter;
int target_filter_tableId(){return 363;};
...
int children_skill_tableId(){return 337;};
...
int cast_effect_tableId(){return 115;};
BnsTables::Shared::TableRef cast_effect_to_my_summoned_summoner[4];
int cast_effect_to_my_summoned_summoner_tableId(){return 115;};
...
int target_kill_effect_tableId(){return 115;};
...
int cancel_flow_repeat_next_skill_tableId(){return 337;};
...
int exec_effect_1_tableId(){return 116;};
...
int exec_effect_2_tableId(){return 116;};
...
int exec_effect_3_tableId(){return 116;};
...
int exec_effect_4_tableId(){return 116;};
...
int exec_effect_5_tableId(){return 116;};
...
int trigger_effect_tableId(){return 116;};
BnsTables::Shared::TableRef trigger_prev_skill;
int trigger_prev_skill_tableId(){return 337;};
__int32 trigger_prev_skill_id;
BnsTables::Shared::TableRef succession_prev_skill;
int succession_prev_skill_tableId(){return 337;};
...
int boss_resistible_skill_message_tableId(){return 420;};
...
int ui_recycle_name_tableId(){return 420;};
BnsTables::Shared::TableRef ui_recycle_description;
int ui_recycle_description_tableId(){return 420;};
...
int ui_show_effect_stack_tableId(){return 115;};
