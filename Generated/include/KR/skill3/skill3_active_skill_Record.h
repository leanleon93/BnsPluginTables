...
int dash_attribute_tableId() const {return 374;};
bool sit_down;
signed char hostile_type;
char Pad_sub_2[2];
BnsTables::Shared::TableRef target_filter;
int target_filter_tableId() const {return 391;};
...
int switch_off_id_tableId() const {return 361;};
...
int result_controll_tableId() const {return 383;};
...
int children_skill_tableId() const {return 361;};
...
int cancel_flow_repeat_next_skill_tableId() const {return 361;};
...
int trigger_prev_skill_tableId() const {return 361;};
__int32 trigger_prev_skill_id;
BnsTables::Shared::TableRef succession_prev_skill;
int succession_prev_skill_tableId() const {return 361;};
...
int boss_resistible_skill_message_tableId() const {return 448;};
...
int ui_recycle_name_tableId() const {return 448;};
BnsTables::Shared::TableRef ui_recycle_description;
int ui_recycle_description_tableId() const {return 448;};
