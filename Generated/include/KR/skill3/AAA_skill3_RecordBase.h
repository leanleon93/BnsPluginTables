...
int skill_modify_limit_tableId() const {return 378;};
bool is_ego_skill;
...
int description_weapon_soul_gem_tableId() const {return 444;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 383;};
BnsTables::Shared::TableRef skill_arcane_info;
int skill_arcane_info_tableId() const {return 360;};
