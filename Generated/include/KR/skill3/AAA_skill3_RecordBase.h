...
int skill_modify_limit_tableId() const {return 361;};
bool is_ego_skill;
...
int description_weapon_soul_gem_tableId() const {return 427;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 366;};
BnsTables::Shared::TableRef skill_arcane_info;
int skill_arcane_info_tableId() const {return 344;};

		static BnsTables::Shared::TableVersion Version() { return BnsTables::Shared::TableVersion(10, 8); }
