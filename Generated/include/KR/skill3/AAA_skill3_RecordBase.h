...
int skill_modify_limit_tableId() const {return 379;};
bool is_ego_skill;
...
int systematization_tableId() const {return 385;};
...
int description_weapon_soul_gem_tableId() const {return 445;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 384;};
BnsTables::Shared::TableRef skill_arcane_info;
int skill_arcane_info_tableId() const {return 361;};
