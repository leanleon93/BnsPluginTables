...
int skill_modify_limit_tableId() const {return 381;};
bool is_ego_skill;
...
int systematization_tableId() const {return 387;};
...
int description_weapon_soul_gem_tableId() const {return 447;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 386;};
BnsTables::Shared::TableRef skill_arcane_info;
int skill_arcane_info_tableId() const {return 362;};
