...
int skill_modify_limit_tableId() const {return 359;};
bool is_ego_skill;
...
int systematization_tableId() const {return 365;};
...
int description_weapon_soul_gem_tableId() const {return 425;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 364;};

		static BnsTables::Shared::TableVersion Version() { return BnsTables::Shared::TableVersion(10, 7); }
