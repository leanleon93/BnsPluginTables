...
int skill_modify_limit_tableId() const {return 375;};
bool is_ego_skill;
...
int description_weapon_soul_gem_tableId() const {return 441;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 380;};
BnsTables::Shared::TableRef skill_arcane_info;
int skill_arcane_info_tableId() const {return 358;};
