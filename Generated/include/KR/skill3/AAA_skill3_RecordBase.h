...
int skill_modify_limit_tableId() const {return 368;};
bool is_ego_skill;
...
int description_weapon_soul_gem_tableId() const {return 434;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 373;};
