...
namespace BnsTables::EU {
	...
	enum class target {
		...
		museum_info = 78,
		card_collection = 79,
		inventory_card_collection = 80,
		achievement_item_reward = 81,
		soul_boost = 82,
		battle_pass = 83,
		inventory_card_expedition = 84,
		expedition_collaction = 85,
		expedition_card = 86,
		expedition_monster = 87,
		expedition_stroy = 88,
		expedition_view_point = 89,
		relics = 90,
		inventory_relics = 91,
		combine_relics = 92,
		enhance_relics = 93,
		disassemble_relics = 94,
		achievement_inspector = 95,
		inventory_randomoption_reset = 96,
	};
