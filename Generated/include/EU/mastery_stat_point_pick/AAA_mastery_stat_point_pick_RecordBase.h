...
signed char stat_point_job;
		...
		std::string_view stat_point_pick_attribute_EnumValue() const {return Get_stat_point_pick_attribute_EnumValue(key.stat_point_pick_attribute);};
std::string_view stat_point_job_EnumValue() const {return Get_stat_point_job_EnumValue(key.stat_point_job);};
