...
int slogan_tableId() const {return 447;};
BnsTables::Shared::TableRef introduction_description;
int introduction_description_tableId() const {return 447;};
...
int representative_product_label_tableId() const {return 447;};
...
int special_product_label_tableId() const {return 447;};
