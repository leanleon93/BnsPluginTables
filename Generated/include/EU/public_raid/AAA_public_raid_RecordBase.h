...
int start_weekly_time_tableId() const {return 452;};
...
int enter_pc_spawn_tableId() const {return 478;};
BnsTables::Shared::TableRef publicraid_name2;
int publicraid_name2_tableId() const {return 426;};
BnsTables::Shared::TableRef publicraid_desc;
int publicraid_desc_tableId() const {return 426;};
