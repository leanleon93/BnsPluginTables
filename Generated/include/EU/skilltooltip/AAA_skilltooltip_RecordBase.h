...
int skill_tableId() const {return 364;};
...
int item_default_text_tableId() const {return 454;};
BnsTables::Shared::TableRef item_replace_text;
int item_replace_text_tableId() const {return 454;};
