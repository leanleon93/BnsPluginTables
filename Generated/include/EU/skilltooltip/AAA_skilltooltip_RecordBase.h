...
int skill_tableId() const {return 359;};
...
int item_default_text_tableId() const {return 445;};
BnsTables::Shared::TableRef item_replace_text;
int item_replace_text_tableId() const {return 445;};
