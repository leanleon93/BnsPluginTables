...
int apply_skill_modifys_tableId() const {return 380;};
...
int apply_skill_modify_per_arcane_score_tableId() const {return 380;};
...
int effect_tooltip_description_tableId() const {return 448;};
