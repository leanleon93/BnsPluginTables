...
int name_party_number_tableId() const {return 454;};
...
int group_name_tableId() const {return 454;};
signed char grade;
char Pad2[1];
...
int interdungeon_tableId() const {return 200;};
BnsTables::Shared::TableRef party_match;
int party_match_tableId() const {return 295;};
