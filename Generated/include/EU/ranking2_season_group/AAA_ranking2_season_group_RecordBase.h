...
int contents_tableId() const {return 314;};
BnsTables::Shared::TableRef season[10];
__int32 season_Size() const {return 10;};
int season_tableId() const {return 318;};
BnsTables::Shared::TableRef main_season;
int main_season_tableId() const {return 318;};
...
int tier_contents_seasons_tableId() const {return 319;};
BnsTables::Shared::TableRef tier;
int tier_tableId() const {return 321;};
