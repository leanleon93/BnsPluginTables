...
int challenge_npc_kill_tableId() const {return 283;};
...
int challenge_npc_quest_tableId() const {return 313;};
...
int account_reward_quota_tableId() const {return 70;};
