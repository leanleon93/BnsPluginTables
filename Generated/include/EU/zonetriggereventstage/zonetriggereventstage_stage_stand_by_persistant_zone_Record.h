...
int event_channel_text_tableId() const {return 434;};
BnsTables::Shared::TableRef event_notify_diff_zone[6];
__int32 event_notify_diff_zone_Size() const {return 6;};
int event_notify_diff_zone_tableId() const {return 478;};
BnsTables::Shared::TableRef event_notify_diff_zone_msg;
int event_notify_diff_zone_msg_tableId() const {return 159;};
BnsTables::Shared::TableRef event_notify_diff_channel_msg;
int event_notify_diff_channel_msg_tableId() const {return 159;};
BnsTables::Shared::TableRef event_notify_msg;
int event_notify_msg_tableId() const {return 159;};
