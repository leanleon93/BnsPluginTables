...
int event_returning_user_title_tableId() const {return 447;};
BnsTables::Shared::TableRef event_returning_user_popup_title;
int event_returning_user_popup_title_tableId() const {return 447;};
BnsTables::Shared::TableRef event_returning_user_popup_desc;
int event_returning_user_popup_desc_tableId() const {return 447;};
