...
int lobby_slot_job_icon_texture_tableId() const {return 194;};
...
signed char lobby_chart_difficulty;
char Pad3[3];
...
int skill_train_ui_trait_open_button_text_tableId() const {return 454;};
...
int skill_train_ui_page_job_style_name_tableId() const {return 454;};
...
int contents_journal_job_style_icon_tableId() const {return 454;};
...
float phantom_weapon_sync_time;
		...
		enum class lobby_chart_difficulty {
			easy = 0,
			normal = 1,
			hard = 2,
		};
