...
int skill_train_ui_trait_open_button_text_tableId() const {return 447;};
...
int skill_train_ui_page_job_style_name_tableId() const {return 447;};
...
int contents_journal_job_style_icon_tableId() const {return 447;};
