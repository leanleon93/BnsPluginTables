...
int requirement_name_tableId() const {return 445;};
BnsTables::Shared::TableRef location_desc;
int location_desc_tableId() const {return 445;};
...
int complete_quest_tableId() const {return 313;};
...
int step_tableId() const {return 88;};
