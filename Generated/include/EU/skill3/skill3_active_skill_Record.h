...
int dash_attribute_tableId() const {return 362;};
bool sit_down;
signed char hostile_type;
char Pad_sub_1[2];
BnsTables::Shared::TableRef target_filter;
int target_filter_tableId() const {return 378;};
...
int switch_off_id_tableId() const {return 350;};
...
int result_controll_tableId() const {return 370;};
...
int children_skill_tableId() const {return 350;};
...
int cancel_flow_repeat_next_skill_tableId() const {return 350;};
...
int trigger_prev_skill_tableId() const {return 350;};
__int32 trigger_prev_skill_id;
BnsTables::Shared::TableRef succession_prev_skill;
int succession_prev_skill_tableId() const {return 350;};
...
int boss_resistible_skill_message_tableId() const {return 435;};
...
int ui_recycle_name_tableId() const {return 435;};
BnsTables::Shared::TableRef ui_recycle_description;
int ui_recycle_description_tableId() const {return 435;};
