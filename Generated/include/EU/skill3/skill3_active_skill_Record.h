...
int dash_attribute_tableId() const {return 353;};
bool sit_down;
signed char hostile_type;
char Pad_sub_1[2];
BnsTables::Shared::TableRef target_filter;
int target_filter_tableId() const {return 369;};
...
int result_controll_tableId() const {return 361;};
...
int perfect_dodge_gather_range_tableId() const {return 355;};
...
int boss_resistible_skill_message_tableId() const {return 426;};
...
int ui_recycle_name_tableId() const {return 426;};
BnsTables::Shared::TableRef ui_recycle_description;
int ui_recycle_description_tableId() const {return 426;};
