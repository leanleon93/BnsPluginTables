...
int dash_attribute_tableId() const {return 373;};
bool sit_down;
signed char hostile_type;
char Pad_sub_2[2];
BnsTables::Shared::TableRef target_filter;
int target_filter_tableId() const {return 390;};
...
int switch_off_id_tableId() const {return 360;};
...
int result_controll_tableId() const {return 382;};
...
int children_skill_tableId() const {return 360;};
...
int cast_effect_tableId() const {return 121;};
...
int cast_effect_to_my_summoned_summoner_tableId() const {return 121;};
...
char Pad_sub_9[1];
__int16 consume_repeat_sp_value[2];
__int32 consume_repeat_sp_value_Size() const {return 2;};
BnsTables::Shared::TableRef target_kill_effect[4];
__int32 target_kill_effect_Size() const {return 4;};
int target_kill_effect_tableId() const {return 121;};
...
int cancel_flow_repeat_next_skill_tableId() const {return 360;};
signed char charge_cancel_force_use_unpress_skill;
...
int perfect_dodge_success_effect_tableId() const {return 121;};
...
int exec_effect_1_tableId() const {return 122;};
...
int exec_effect_2_tableId() const {return 122;};
...
int exec_effect_3_tableId() const {return 122;};
...
int exec_effect_4_tableId() const {return 122;};
...
int exec_effect_5_tableId() const {return 122;};
...
int trigger_effect_tableId() const {return 122;};
BnsTables::Shared::TableRef trigger_prev_skill;
int trigger_prev_skill_tableId() const {return 360;};
__int32 trigger_prev_skill_id;
BnsTables::Shared::TableRef succession_prev_skill;
int succession_prev_skill_tableId() const {return 360;};
...
int boss_resistible_skill_message_tableId() const {return 447;};
...
int ui_recycle_name_tableId() const {return 447;};
BnsTables::Shared::TableRef ui_recycle_description;
int ui_recycle_description_tableId() const {return 447;};
...
int ui_show_effect_stack_tableId() const {return 121;};
