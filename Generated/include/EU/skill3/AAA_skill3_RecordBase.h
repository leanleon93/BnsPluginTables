...
int skill_modify_limit_tableId() const {return 354;};
bool is_ego_skill;
...
int description_weapon_soul_gem_tableId() const {return 420;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 359;};

		static BnsTables::Shared::TableVersion Version() { return BnsTables::Shared::TableVersion(10, 5); }
