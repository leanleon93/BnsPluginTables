...
int skill_modify_limit_tableId() const {return 386;};
bool is_ego_skill;
...
int systematization_tableId() const {return 392;};
...
int description_weapon_soul_gem_tableId() const {return 454;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 391;};
BnsTables::Shared::TableRef skill_arcane_info;
int skill_arcane_info_tableId() const {return 366;};
bool ignore_hit_reaction;

		static BnsTables::Shared::TableVersion Version() { return BnsTables::Shared::TableVersion(11, 2); }
