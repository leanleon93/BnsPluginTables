...
int skill_modify_limit_tableId() const {return 382;};
bool is_ego_skill;
...
int systematization_tableId() const {return 388;};
...
int description_weapon_soul_gem_tableId() const {return 448;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 387;};
BnsTables::Shared::TableRef skill_arcane_info;
int skill_arcane_info_tableId() const {return 363;};
