...
int skill_modify_limit_tableId() const {return 360;};
bool is_ego_skill;
...
int description_weapon_soul_gem_tableId() const {return 426;};
BnsTables::Shared::TableRef skill_style;
int skill_style_tableId() const {return 365;};
BnsTables::Shared::TableRef skill_arcane_info;
int skill_arcane_info_tableId() const {return 343;};
