...
int title2_tableId() const {return 435;};
...
int store_tableId() const {return 415;};
BnsTables::Shared::TableRef store_by_item;
int store_by_item_tableId() const {return 414;};
...
int personal_dropped_pouch_reward_tableId() const {return 340;};
BnsTables::Shared::TableRef personal_dropped_pouch_event_reward;
int personal_dropped_pouch_event_reward_tableId() const {return 340;};
...
int personal_dropped_pouch_reward_difficulty_type_tableId() const {return 340;};
BnsTables::Shared::TableRef reward_sealed_dungeon;
int reward_sealed_dungeon_tableId() const {return 281;};
BnsTables::Shared::TableRef dungeon_challenge_reward;
int dungeon_challenge_reward_tableId() const {return 340;};
...
int action_name_tableId() const {return 435;};
...
int manipulate_transit_zone_tableId() const {return 480;};
...
int finish_blow_quests_tableId() const {return 307;};
...
int default_idle_tableId() const {return 279;};
bool warfare_boss;
char Pad16[3];
__int64 max_hp;
__int16 max_sp;
...
int grade_tooltip_text_tableId() const {return 435;};
...
int end_talk_social_tableId() const {return 397;};
...
int dying_message_tableId() const {return 435;};
signed char role_type;
char Pad25[3];
BnsTables::Shared::TableRef die_shout;
int die_shout_tableId() const {return 435;};
...
int summoned_beauty_shop_tableId() const {return 417;};
...
int map_unit_tableId() const {return 259;};
...
int newbiecare_tableId() const {return 275;};
