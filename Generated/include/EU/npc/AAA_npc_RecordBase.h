...
int title2_tableId() const {return 438;};
...
int store_tableId() const {return 418;};
BnsTables::Shared::TableRef store_by_item;
int store_by_item_tableId() const {return 417;};
...
int personal_dropped_pouch_reward_tableId() const {return 343;};
BnsTables::Shared::TableRef personal_dropped_pouch_event_reward;
int personal_dropped_pouch_event_reward_tableId() const {return 343;};
...
int personal_dropped_pouch_reward_difficulty_type_tableId() const {return 343;};
BnsTables::Shared::TableRef reward_sealed_dungeon;
int reward_sealed_dungeon_tableId() const {return 283;};
BnsTables::Shared::TableRef dungeon_challenge_reward;
int dungeon_challenge_reward_tableId() const {return 343;};
...
int action_name_tableId() const {return 438;};
...
int manipulate_transit_zone_tableId() const {return 483;};
...
int loot_quests_tableId() const {return 309;};
...
int loot_item_tableId() const {return 203;};
...
int finish_blow_quests_tableId() const {return 309;};
...
int default_idle_tableId() const {return 281;};
bool warfare_boss;
char Pad16[3];
__int64 max_hp;
__int16 max_sp;
...
int grade_tooltip_text_tableId() const {return 438;};
...
int boss_spawn_message_tableId() const {return 160;};
...
int end_talk_social_tableId() const {return 400;};
...
int dying_message_tableId() const {return 438;};
signed char role_type;
char Pad25[3];
BnsTables::Shared::TableRef die_shout;
int die_shout_tableId() const {return 438;};
signed char race_type;
char Pad26[3];
BnsTables::Shared::TableRef indicator;
int indicator_tableId() const {return 192;};
...
int summoned_beauty_shop_tableId() const {return 420;};
...
int map_unit_tableId() const {return 261;};
...
int newbiecare_tableId() const {return 277;};
