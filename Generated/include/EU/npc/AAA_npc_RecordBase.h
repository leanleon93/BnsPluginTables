...
int title2_tableId() const {return 426;};
...
int store_tableId() const {return 406;};
BnsTables::Shared::TableRef store_by_item;
int store_by_item_tableId() const {return 405;};
...
int personal_dropped_pouch_reward_tableId() const {return 331;};
...
int personal_dropped_pouch_reward_difficulty_type_tableId() const {return 331;};
BnsTables::Shared::TableRef reward_sealed_dungeon;
int reward_sealed_dungeon_tableId() const {return 273;};
...
int action_name_tableId() const {return 426;};
...
int manipulate_transit_zone_tableId() const {return 469;};
...
int finish_blow_quests_tableId() const {return 298;};
...
int default_idle_tableId() const {return 271;};
bool warfare_boss;
char Pad16[3];
__int64 max_hp;
__int16 max_sp;
...
int grade_tooltip_text_tableId() const {return 426;};
...
int dying_message_tableId() const {return 426;};
signed char role_type;
char Pad24[3];
BnsTables::Shared::TableRef die_shout;
int die_shout_tableId() const {return 426;};
signed char race_type;
char Pad25[3];
BnsTables::Shared::TableRef indicator;
int indicator_tableId() const {return 186;};
...
int summoned_beauty_shop_tableId() const {return 408;};
...
int map_unit_tableId() const {return 251;};
...
int newbiecare_tableId() const {return 267;};
