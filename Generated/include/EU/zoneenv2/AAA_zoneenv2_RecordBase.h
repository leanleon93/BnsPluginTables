...
int required_fielditem_tableId() const {return 150;};
BnsTables::Shared::TableRef manipulate_by_item;
int manipulate_by_item_tableId() const {return 207;};
...
int manipulated_effect_tableId() const {return 121;};
BnsTables::Shared::TableRef main_faction_effect;
int main_faction_effect_tableId() const {return 121;};
__int16 main_faction_effect_distance;
char Pad4[2];
BnsTables::Shared::TableRef cannot_manipulate_effect;
int cannot_manipulate_effect_tableId() const {return 121;};
...
int required_activated_faction_tableId() const {return 143;};
...
int action_name2_tableId() const {return 447;};
BnsTables::Shared::TableRef action_desc2;
int action_desc2_tableId() const {return 447;};
bool hide_close;
bool hide_empty;
bool tooltip_option;
...
int image_text_tableId() const {return 447;};
