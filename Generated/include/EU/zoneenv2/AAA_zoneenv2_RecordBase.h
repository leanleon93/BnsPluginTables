...
int required_fielditem_tableId() const {return 142;};
BnsTables::Shared::TableRef manipulate_by_item;
int manipulate_by_item_tableId() const {return 195;};
...
int required_activated_faction_tableId() const {return 135;};
...
int image_text_tableId() const {return 420;};
