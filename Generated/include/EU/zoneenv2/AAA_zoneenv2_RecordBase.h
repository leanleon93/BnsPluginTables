...
int required_fielditem_tableId() const {return 143;};
BnsTables::Shared::TableRef manipulate_by_item;
int manipulate_by_item_tableId() const {return 197;};
...
int manipulated_effect_tableId() const {return 115;};
BnsTables::Shared::TableRef main_faction_effect;
int main_faction_effect_tableId() const {return 115;};
__int16 main_faction_effect_distance;
char Pad4[2];
BnsTables::Shared::TableRef cannot_manipulate_effect;
int cannot_manipulate_effect_tableId() const {return 115;};
...
int required_activated_faction_tableId() const {return 136;};
...
int action_name2_tableId() const {return 426;};
BnsTables::Shared::TableRef action_desc2;
int action_desc2_tableId() const {return 426;};
bool hide_close;
bool hide_empty;
bool tooltip_option;
...
int loot_quests_tableId() const {return 298;};
...
int loot_item_tableId() const {return 197;};
bool lootable;
char Pad8[3];
...
int image_text_tableId() const {return 426;};
