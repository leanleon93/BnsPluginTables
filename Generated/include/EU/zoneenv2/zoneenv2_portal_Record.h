...
int transit_zone_tableId() const {return 493;};
...
int transit_pc_spawn_in_arena_tableId() const {return 502;};
...
int transit_leave_social_tableId() const {return 410;};
BnsTables::Shared::TableRef transit_enter_social;
int transit_enter_social_tableId() const {return 410;};
