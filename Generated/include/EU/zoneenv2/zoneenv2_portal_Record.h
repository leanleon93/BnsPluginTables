...
int transit_leave_social_tableId() const {return 397;};
BnsTables::Shared::TableRef transit_enter_social;
int transit_enter_social_tableId() const {return 397;};
