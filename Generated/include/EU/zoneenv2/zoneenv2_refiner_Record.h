...
int refined_reward_item_tableId() const {return 197;};
...
int occupy_action_name_tableId() const {return 426;};
...
int try_refine_action_name_tableId() const {return 426;};
...
int give_score_action_name_tableId() const {return 426;};
BnsTables::Shared::TableRef give_score_social;
int give_score_social_tableId() const {return 388;};
...
int accroach_action_name_tableId() const {return 426;};
