...
int refined_reward_item_tableId() const {return 203;};
...
int occupy_action_name_tableId() const {return 438;};
...
int try_refine_action_name_tableId() const {return 438;};
...
int give_score_action_name_tableId() const {return 438;};
BnsTables::Shared::TableRef give_score_social;
int give_score_social_tableId() const {return 400;};
...
int accroach_action_name_tableId() const {return 438;};
