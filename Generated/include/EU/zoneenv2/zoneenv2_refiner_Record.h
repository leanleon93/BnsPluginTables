...
int refined_reward_item_tableId() const {return 198;};
...
int occupy_action_name_tableId() const {return 427;};
...
int try_refine_action_name_tableId() const {return 427;};
...
int give_score_action_name_tableId() const {return 427;};
BnsTables::Shared::TableRef give_score_social;
int give_score_social_tableId() const {return 389;};
...
int accroach_action_name_tableId() const {return 427;};
