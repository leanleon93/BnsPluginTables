...
char Pad0[3];
BnsTables::Shared::TableRef mission_task[100];
__int32 mission_task_Size() const {return 100;};
int mission_task_tableId() const {return 421;};
BnsTables::Shared::TableRef mission_step_reward_item[4];
__int32 mission_step_reward_item_Size() const {return 4;};
int mission_step_reward_item_tableId() const {return 208;};
