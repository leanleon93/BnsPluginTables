...
#pragma pack(push, 1)
	struct quest_fixed_reward_Record : BnsTables::Shared::DrEl
	{
	public:
		union Key
		{
...
#pragma pack(pop)
#pragma pack(push, 1)
	struct __declspec(align(4)) quest_fixed_reward_RecordPtr // : DrRecordPtr
	{
		quest_fixed_reward_Record* _record;
