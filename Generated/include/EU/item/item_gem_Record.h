...
int reveal_consumable_item_tableId() const {return 202;};
...
int equip_gem_piece_tableId() const {return 126;};
...
int attach_equip_gem_piece_consumable_item_tableId() const {return 202;};
...
int attach_equip_gem_piece_tableId() const {return 126;};
...
int attack_effect_tableId() const {return 118;};
...
int second_attack_effect_tableId() const {return 118;};
...
int main_ability_fixed_tableId() const {return 218;};
BnsTables::Shared::TableRef sub_ability_fixed;
int sub_ability_fixed_tableId() const {return 218;};
...
int sub_ability_random_tableId() const {return 218;};
BnsTables::Shared::TableRef feed_ability_random[8];
__int32 feed_ability_random_Size() const {return 8;};
int feed_ability_random_tableId() const {return 218;};
...
int ability_feeding_required_item_tableId() const {return 202;};
...
int ability_feeding_special_item_tableId() const {return 202;};
...
int ability_feeding_target_tableId() const {return 195;};
BnsTables::Shared::TableRef skill_by_equipment;
int skill_by_equipment_tableId() const {return 357;};
__int16 hidden_power_attach;
char Pad_sub_9[2];
BnsTables::Shared::TableRef weapon_soul_gem_pet;
int weapon_soul_gem_pet_tableId() const {return 297;};
...
int sub_ability_random_draw_cost_tableId() const {return 79;};
