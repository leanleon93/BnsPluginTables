...
int main_ability_fixed_tableId() const {return 224;};
BnsTables::Shared::TableRef sub_ability_fixed;
int sub_ability_fixed_tableId() const {return 224;};
...
int sub_ability_random_tableId() const {return 224;};
BnsTables::Shared::TableRef feed_ability_random[8];
__int32 feed_ability_random_Size() const {return 8;};
int feed_ability_random_tableId() const {return 224;};
...
int skill_by_equipment_tableId() const {return 369;};
__int16 hidden_power_attach;
char Pad_sub_9[2];
BnsTables::Shared::TableRef weapon_soul_gem_pet;
int weapon_soul_gem_pet_tableId() const {return 306;};
