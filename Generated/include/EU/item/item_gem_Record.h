...
int reveal_consumable_item_tableId() const {return 203;};
...
int attach_equip_gem_piece_consumable_item_tableId() const {return 203;};
...
int main_ability_fixed_tableId() const {return 219;};
BnsTables::Shared::TableRef sub_ability_fixed;
int sub_ability_fixed_tableId() const {return 219;};
...
int sub_ability_random_tableId() const {return 219;};
BnsTables::Shared::TableRef feed_ability_random[8];
__int32 feed_ability_random_Size() const {return 8;};
int feed_ability_random_tableId() const {return 219;};
...
int ability_feeding_required_item_tableId() const {return 203;};
...
int ability_feeding_special_item_tableId() const {return 203;};
...
int ability_feeding_target_tableId() const {return 196;};
BnsTables::Shared::TableRef skill_by_equipment;
int skill_by_equipment_tableId() const {return 361;};
__int16 hidden_power_attach;
char Pad_sub_8[2];
BnsTables::Shared::TableRef weapon_soul_gem_pet;
int weapon_soul_gem_pet_tableId() const {return 300;};
