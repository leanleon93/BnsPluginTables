...
int duel_skill3_tableId() const {return 364;};
...
int skill_limit_faction_tableId() const {return 143;};
__int16 skill_limit_faction_level;
char Pad_sub_4[2];
BnsTables::Shared::TableRef skill_limit_activated_faction;
int skill_limit_activated_faction_tableId() const {return 143;};
...
int skill_skin_acquire_tableId() const {return 389;};
BnsTables::Shared::TableRef resurrect_effect;
int resurrect_effect_tableId() const {return 121;};
__int32 bonus_exp;
...
int bonus_sealed_dungeon_id_tableId() const {return 120;};
...
__int16 world_account_expedition_complete[50];
__int32 world_account_expedition_complete_Size() const {return 50;};
...
int valid_attraction_name_tableId() const {return 454;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 501;};
...
int unseal_acquire_item_tableId() const {return 208;};
...
int unseal_result_preview_item_tableId() const {return 208;};
...
int skill_train_by_item_for_transmit_tableId() const {return 398;};
BnsTables::Shared::TableRef decompose_random_box_replaced_by_decompose_item;
int decompose_random_box_replaced_by_decompose_item_tableId() const {return 208;};
__int32 reinforce_skill_train_by_item_extract_id;
signed char reinforce_skill_train_by_item_extract_level;
char Pad_sub_19[3];
BnsTables::Shared::TableRef reinforce_skill_train_by_item_extract_next_item;
int reinforce_skill_train_by_item_extract_next_item_tableId() const {return 208;};
BnsTables::Shared::TableRef reinforce_skill_train_by_item_extract_prev_item;
int reinforce_skill_train_by_item_extract_prev_item_tableId() const {return 208;};
