...
int duel_skill3_tableId() const {return 337;};
...
int skill_limit_faction_tableId() const {return 135;};
__int16 skill_limit_faction_level;
char Pad_sub_3[2];
BnsTables::Shared::TableRef skill_limit_activated_faction;
int skill_limit_activated_faction_tableId() const {return 135;};
...
int skill_skin_acquire_tableId() const {return 357;};
...
int valid_attraction_name_tableId() const {return 420;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 461;};
...
int unseal_acquire_item_tableId() const {return 195;};
...
int unseal_result_preview_item_tableId() const {return 195;};
