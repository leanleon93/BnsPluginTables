...
int skill_skin_acquire_tableId() const {return 363;};
...
int valid_attraction_name_tableId() const {return 426;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 469;};
...
int slate_scroll_tableId() const {return 384;};
...
int card_tableId() const {return 455;};
...
int skill_train_by_item_for_transmit_tableId() const {return 372;};
