...
int duel_skill3_tableId() const {return 350;};
...
int skill_skin_acquire_tableId() const {return 372;};
...
int valid_attraction_name_tableId() const {return 435;};
BnsTables::Shared::TableRef dest_zone;
int dest_zone_tableId() const {return 480;};
...
int slate_scroll_tableId() const {return 393;};
...
int card_tableId() const {return 464;};
...
int skill_train_by_item_for_transmit_tableId() const {return 381;};
