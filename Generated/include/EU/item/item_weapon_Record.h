...
int identify_grocery_tableId() const {return 206;};
...
int open_gem_slot_grocery_tableId() const {return 206;};
...
int ui_repair_item_tableId() const {return 206;};
...
int pet_tableId() const {return 304;};
...
int init_star_stone_slot_cost_group_tableId() const {return 81;};
BnsTables::Shared::TableRef star_stone_slot_expansion_cost[9];
__int32 star_stone_slot_expansion_cost_Size() const {return 9;};
int star_stone_slot_expansion_cost_tableId() const {return 81;};
