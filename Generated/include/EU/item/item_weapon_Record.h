...
int identify_grocery_tableId() const {return 203;};
...
int open_gem_slot_grocery_tableId() const {return 203;};
...
int ui_repair_item_tableId() const {return 203;};
...
int pet_tableId() const {return 300;};
