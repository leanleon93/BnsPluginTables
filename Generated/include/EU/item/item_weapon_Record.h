...
int identify_grocery_tableId() const {return 208;};
...
int open_gem_slot_grocery_tableId() const {return 208;};
...
int ui_repair_item_tableId() const {return 208;};
...
int pet_tableId() const {return 308;};
__int32 closet_group_id;
BnsTables::Shared::TableRef skill_skin;
int skill_skin_tableId() const {return 389;};
