...
int vehicle_detail_tableId() const {return 471;};
...
BnsTables::Shared::TableRef gem_appearance_set;
int gem_appearance_set_tableId() const {return 166;};
...
int init_star_stone_slot_cost_group_tableId() const {return 82;};
BnsTables::Shared::TableRef star_stone_slot_expansion_cost[9];
__int32 star_stone_slot_expansion_cost_Size() const {return 9;};
int star_stone_slot_expansion_cost_tableId() const {return 82;};
__int16 star_stone_slot_expansion_probability[9];
__int32 star_stone_slot_expansion_probability_Size() const {return 9;};
