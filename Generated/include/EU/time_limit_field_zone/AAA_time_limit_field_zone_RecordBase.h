...
int time_limit_field_zone_name2_tableId() const {return 454;};
BnsTables::Shared::TableRef time_limit_field_zone_desc;
int time_limit_field_zone_desc_tableId() const {return 454;};
BnsTables::Shared::TableRef time_limit_field_zone_desc2;
int time_limit_field_zone_desc2_tableId() const {return 454;};
...
int field_bonus_effect_desc1_tableId() const {return 454;};
BnsTables::Shared::TableRef field_bonus_effect_desc2;
int field_bonus_effect_desc2_tableId() const {return 454;};
BnsTables::Shared::TableRef field_bonus_effect_desc3;
int field_bonus_effect_desc3_tableId() const {return 454;};
