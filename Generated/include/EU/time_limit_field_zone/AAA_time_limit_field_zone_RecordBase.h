...
int field_bonus_effect_desc1_tableId() const {return 434;};
BnsTables::Shared::TableRef field_bonus_effect_desc2;
int field_bonus_effect_desc2_tableId() const {return 434;};
BnsTables::Shared::TableRef field_bonus_effect_desc3;
int field_bonus_effect_desc3_tableId() const {return 434;};
