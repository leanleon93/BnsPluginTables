...
int acquire_quest_tableId() const {return 315;};
...
int drop_action_name_tableId() const {return 448;};
BnsTables::Shared::TableRef drop_action_desc;
int drop_action_desc_tableId() const {return 448;};
