...
int upgrade_grocery_tableId() const {return 234;};
...
int main_ingredient_title_name_tableId() const {return 445;};
BnsTables::Shared::TableRef main_ingredient_title_item;
int main_ingredient_title_item_tableId() const {return 206;};
...
int random_failure_mileage_distribution_type_tableId() const {return 324;};
...
int random_failure_mileage_influence_recipe_tableId() const {return 230;};
BnsTables::Shared::TableRef random_retry_cost;
int random_retry_cost_tableId() const {return 233;};
...
int coupon_item_tableId() const {return 206;};
