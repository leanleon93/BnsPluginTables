...
int random_item_tooltip_text_tableId() const {return 438;};
...
int paid_fixed_item_tableId() const {return 203;};
...
int paid_random_item_tableId() const {return 203;};
...
int paid_random_item_tooltip_text_tableId() const {return 438;};
