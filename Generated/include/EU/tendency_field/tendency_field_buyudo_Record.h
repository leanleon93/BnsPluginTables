...
int playable_time_tableId() const {return 452;};
...
int reentrance_faction1_spawn_tableId() const {return 478;};
BnsTables::Shared::TableRef reentrance_faction2_spawn;
int reentrance_faction2_spawn_tableId() const {return 478;};
