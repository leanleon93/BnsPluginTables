...
int transfer_pcspawn_by_deprecated_tableId() const {return 478;};
BnsTables::Shared::TableRef chat_channel;
int chat_channel_tableId() const {return 403;};
...
int respawn_tableId() const {return 479;};
...
int respawn_by_activated_faction_tableId() const {return 479;};
BnsTables::Shared::TableRef basecamp;
int basecamp_tableId() const {return 464;};
...
int reentrance_pcspawn_tableId() const {return 478;};
BnsTables::Shared::TableRef reentrance_pcspawn_in_arena;
int reentrance_pcspawn_in_arena_tableId() const {return 478;};
BnsTables::Shared::TableRef sealed_dungeon_reentrance_pcspawn_in_arena;
int sealed_dungeon_reentrance_pcspawn_in_arena_tableId() const {return 478;};
bool use_zone_exit;
char Pad4[3];
...
int phase_zone_tableId() const {return 469;};
...
int phase_main_zone_tableId() const {return 469;};
