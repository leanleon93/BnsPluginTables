...
int transfer_pcspawn_by_deprecated_tableId() const {return 487;};
...
int respawn_tableId() const {return 488;};
...
int respawn_by_activated_faction_tableId() const {return 488;};
...
int reentrance_pcspawn_tableId() const {return 487;};
BnsTables::Shared::TableRef reentrance_pcspawn_in_arena;
int reentrance_pcspawn_in_arena_tableId() const {return 487;};
BnsTables::Shared::TableRef sealed_dungeon_reentrance_pcspawn_in_arena;
int sealed_dungeon_reentrance_pcspawn_in_arena_tableId() const {return 487;};
bool use_zone_exit;
char Pad4[3];
...
int phase_zone_tableId() const {return 478;};
...
int phase_main_zone_tableId() const {return 478;};
