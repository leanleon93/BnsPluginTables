...
int transfer_pcspawn_by_deprecated_tableId() const {return 470;};
BnsTables::Shared::TableRef chat_channel;
int chat_channel_tableId() const {return 397;};
...
int respawn_tableId() const {return 471;};
...
int respawn_by_activated_faction_required_faction_tableId() const {return 135;};
BnsTables::Shared::TableRef respawn_by_activated_faction[2];
__int32 respawn_by_activated_faction_Size() const {return 2;};
int respawn_by_activated_faction_tableId() const {return 471;};
...
int reentrance_pcspawn_tableId() const {return 470;};
BnsTables::Shared::TableRef reentrance_pcspawn_in_arena;
int reentrance_pcspawn_in_arena_tableId() const {return 470;};
BnsTables::Shared::TableRef sealed_dungeon_reentrance_pcspawn_in_arena;
int sealed_dungeon_reentrance_pcspawn_in_arena_tableId() const {return 470;};
bool use_zone_exit;
char Pad4[3];
BnsTables::Shared::TableRef map;
int map_tableId() const {return 247;};
BnsTables::Shared::TableRef area;
int area_tableId() const {return 243;};
...
int phase_quest_tableId() const {return 294;};
...
int phase_zone_tableId() const {return 461;};
...
int phase_main_zone_tableId() const {return 461;};
