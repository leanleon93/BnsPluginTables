...
int raid_dungeon_tableId() const {return 327;};
BnsTables::Shared::TableRef sealed_dungeon_modify;
int sealed_dungeon_modify_tableId() const {return 357;};
...
int tendency_field_tableId() const {return 452;};
BnsTables::Shared::TableRef simple_field;
int simple_field_tableId() const {return 363;};
