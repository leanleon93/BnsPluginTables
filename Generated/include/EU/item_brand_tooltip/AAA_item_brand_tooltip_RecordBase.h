...
signed char item_condition_type;
		...
		std::string_view item_condition_type_EnumValue() const {return Get_item_condition_type_EnumValue(key.item_condition_type);};
...
int store_description_tableId() const {return 420;};
