...
int public_raid_tableId() const {return 310;};
...
int available_party_mode_matching_weekly_time_tableId() const {return 473;};
...
int extra_skill_context_script_tableId() const {return 80;};
