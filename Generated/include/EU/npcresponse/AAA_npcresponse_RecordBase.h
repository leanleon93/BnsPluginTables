...
int required_complete_quest_tableId() const {return 314;};
signed char faction_level_check_type;
char Pad1[3];
BnsTables::Shared::TableRef talk_message;
int talk_message_tableId() const {return 289;};
BnsTables::Shared::TableRef indicator_social;
int indicator_social_tableId() const {return 196;};
BnsTables::Shared::TableRef approach_social;
int approach_social_tableId() const {return 409;};
BnsTables::Shared::TableRef idle;
int idle_tableId() const {return 194;};
bool idle_visible;
char Pad2[3];
BnsTables::Shared::TableRef idle_start;
int idle_start_tableId() const {return 409;};
BnsTables::Shared::TableRef idle_end;
int idle_end_tableId() const {return 409;};
