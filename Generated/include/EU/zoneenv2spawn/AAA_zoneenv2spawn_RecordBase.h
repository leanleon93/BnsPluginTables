...
int env2_tableId() const {return 491;};
BnsTables::Shared::TableRef env2place;
int env2place_tableId() const {return 492;};
BnsTables::Shared::TableRef random_group;
int random_group_tableId() const {return 494;};
BnsTables::Shared::TableRef required_env;
int required_env_tableId() const {return 493;};
