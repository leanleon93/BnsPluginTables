...
int env2_tableId() const {return 502;};
BnsTables::Shared::TableRef env2place;
int env2place_tableId() const {return 503;};
BnsTables::Shared::TableRef random_group;
int random_group_tableId() const {return 505;};
BnsTables::Shared::TableRef required_env;
int required_env_tableId() const {return 504;};
