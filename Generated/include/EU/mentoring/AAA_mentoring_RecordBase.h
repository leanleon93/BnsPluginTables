...
int first_quest_id_tableId() const {return 318;};
BnsTables::Shared::TableRef last_quest_id;
int last_quest_id_tableId() const {return 318;};
...
int mentor_completed_quest_tableId() const {return 318;};
...
int mentee_completed_quest_tableId() const {return 318;};
