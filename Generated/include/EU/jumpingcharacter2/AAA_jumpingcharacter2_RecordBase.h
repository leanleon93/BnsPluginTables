...
int required_preceding_epic_quest_tableId() const {return 309;};
BnsTables::Shared::TableRef last_epic_quest_to_complete;
int last_epic_quest_to_complete_tableId() const {return 309;};
BnsTables::Shared::TableRef quest_to_complete[20];
__int32 quest_to_complete_Size() const {return 20;};
int quest_to_complete_tableId() const {return 309;};
BnsTables::Shared::TableRef warp_to_pcspawn;
int warp_to_pcspawn_tableId() const {return 492;};
BnsTables::Shared::TableRef faction1_item;
int faction1_item_tableId() const {return 203;};
BnsTables::Shared::TableRef faction2_item;
int faction2_item_tableId() const {return 203;};
__int32 reward_exp;
