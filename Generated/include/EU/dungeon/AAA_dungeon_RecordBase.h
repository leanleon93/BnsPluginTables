...
int zone_neutral_tableId() const {return 493;};
...
int arena_entrance_zone_tableId() const {return 493;};
...
int required_preceding_quest_tableId() const {return 315;};
...
int npc_for_step_tableId() const {return 285;};
...
int quest_for_step_tableId() const {return 315;};
...
int dungeon_quest_difficulty_type_tableId() const {return 315;};
...
int skill_score_boss_npc_tableId() const {return 285;};
...
int display_quests_tableId() const {return 315;};
BnsTables::Shared::TableRef tactic_normal;
int tactic_normal_tableId() const {return 448;};
BnsTables::Shared::TableRef tactic_hard;
int tactic_hard_tableId() const {return 448;};
BnsTables::Shared::TableRef tactic_easy;
int tactic_easy_tableId() const {return 448;};
...
int boss_npc_alias_tableId() const {return 285;};
BnsTables::Shared::TableRef boss_npc_section[8];
__int32 boss_npc_section_Size() const {return 8;};
int boss_npc_section_tableId() const {return 448;};
