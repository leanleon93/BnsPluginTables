...
int cave2_name2_tableId() const {return 448;};
BnsTables::Shared::TableRef cave2_desc;
int cave2_desc_tableId() const {return 448;};
...
int quest_for_ignoring_required_level_tableId() const {return 315;};
...
int standard_gear_weapon_tableId() const {return 207;};
...
int tactic_tableId() const {return 448;};
