...
int cave2_name2_tableId() const {return 454;};
BnsTables::Shared::TableRef cave2_desc;
int cave2_desc_tableId() const {return 454;};
...
int quest_for_ignoring_required_level_tableId() const {return 318;};
...
int standard_gear_weapon_tableId() const {return 208;};
...
int tactic_tableId() const {return 454;};
