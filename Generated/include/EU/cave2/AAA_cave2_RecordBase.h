...
int cave2_name2_tableId() const {return 445;};
BnsTables::Shared::TableRef cave2_desc;
int cave2_desc_tableId() const {return 445;};
...
int quest_for_ignoring_required_level_tableId() const {return 313;};
...
int standard_gear_weapon_tableId() const {return 206;};
bool use_fatigability_consume_toggle;
char Pad9[3];
...
int tactic_tableId() const {return 445;};
BnsTables::Shared::TableRef recommend_alias;
int recommend_alias_tableId() const {return 75;};
