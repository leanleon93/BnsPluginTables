...
int reward_event_tableId() const {return 350;};
BnsTables::Shared::TableRef reward_personal_dropped_pouch;
int reward_personal_dropped_pouch_tableId() const {return 350;};
BnsTables::Shared::TableRef reward_personal_dropped_pouch_event;
int reward_personal_dropped_pouch_event_tableId() const {return 350;};
