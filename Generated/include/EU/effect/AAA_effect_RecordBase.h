...
int name3_tableId() const {return 426;};
__int16 level;
bool show_icon;
bool show_left_time;
bool show_linkbar;
...
int description3_tableId() const {return 426;};
...
int description_constellation_tableId() const {return 426;};
...
int description_item_random_option_tableId() const {return 426;};
