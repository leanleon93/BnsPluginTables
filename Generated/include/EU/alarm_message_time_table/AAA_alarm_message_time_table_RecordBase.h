...
int weekly_time_table_tableId() const {return 482;};
...
int clock_alarm_desc_start_tableId() const {return 454;};
BnsTables::Shared::TableRef clock_alarm_desc_progressing;
int clock_alarm_desc_progressing_tableId() const {return 454;};
BnsTables::Shared::TableRef clock_alarm_desc_end;
int clock_alarm_desc_end_tableId() const {return 454;};
BnsTables::Shared::TableRef name2;
int name2_tableId() const {return 454;};
BnsTables::Shared::TableRef hud_icon_tooltip_desc;
int hud_icon_tooltip_desc_tableId() const {return 454;};
