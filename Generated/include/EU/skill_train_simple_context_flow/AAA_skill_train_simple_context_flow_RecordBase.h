...
int equip_item_rune_1_tableId() const {return 202;};
BnsTables::Shared::TableRef equip_item_rune_2;
int equip_item_rune_2_tableId() const {return 202;};
BnsTables::Shared::TableRef equip_item_bracelet;
int equip_item_bracelet_tableId() const {return 202;};
BnsTables::Shared::TableRef key_text;
int key_text_tableId() const {return 434;};
BnsTables::Shared::TableRef function_name;
int function_name_tableId() const {return 434;};
__int32 skill_id[30];
