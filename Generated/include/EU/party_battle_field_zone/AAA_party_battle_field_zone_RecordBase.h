...
int enter_alpha_side_pc_spawn_tableId() const {return 479;};
BnsTables::Shared::TableRef enter_beta_side_pc_spawn;
int enter_beta_side_pc_spawn_tableId() const {return 479;};
BnsTables::Shared::TableRef start_alpha_side_pc_spawn;
int start_alpha_side_pc_spawn_tableId() const {return 479;};
BnsTables::Shared::TableRef start_beta_side_pc_spawn;
int start_beta_side_pc_spawn_tableId() const {return 479;};
__int32 respawn_delay;
BnsTables::Shared::TableRef alpha_side_respawn;
int alpha_side_respawn_tableId() const {return 480;};
BnsTables::Shared::TableRef beta_side_respawn;
int beta_side_respawn_tableId() const {return 480;};
...
int set_env2_target_tableId() const {return 473;};
