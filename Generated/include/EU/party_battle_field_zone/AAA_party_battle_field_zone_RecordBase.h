...
int available_solo_matching_weekly_time_tableId() const {return 461;};
BnsTables::Shared::TableRef available_team_matching_weekly_time;
int available_team_matching_weekly_time_tableId() const {return 461;};
BnsTables::Shared::TableRef available_random_matching_weekly_time;
int available_random_matching_weekly_time_tableId() const {return 461;};
BnsTables::Shared::TableRef disable_calc_rating_score_weekly_time;
int disable_calc_rating_score_weekly_time_tableId() const {return 461;};
BnsTables::Shared::TableRef time_effect_weekly_time;
int time_effect_weekly_time_tableId() const {return 461;};
BnsTables::Shared::TableRef time_effect_weekly_name;
int time_effect_weekly_name_tableId() const {return 435;};
...
int enter_alpha_side_pc_spawn_tableId() const {return 489;};
BnsTables::Shared::TableRef enter_beta_side_pc_spawn;
int enter_beta_side_pc_spawn_tableId() const {return 489;};
BnsTables::Shared::TableRef start_alpha_side_pc_spawn;
int start_alpha_side_pc_spawn_tableId() const {return 489;};
BnsTables::Shared::TableRef start_beta_side_pc_spawn;
int start_beta_side_pc_spawn_tableId() const {return 489;};
__int32 respawn_delay;
BnsTables::Shared::TableRef alpha_side_respawn;
int alpha_side_respawn_tableId() const {return 490;};
BnsTables::Shared::TableRef beta_side_respawn;
int beta_side_respawn_tableId() const {return 490;};
...
int set_env2_target_tableId() const {return 483;};
...
int zone_name2_tableId() const {return 435;};
BnsTables::Shared::TableRef zone_desc;
int zone_desc_tableId() const {return 435;};
...
int zone_sub_desc_tableId() const {return 435;};
...
int weekly_time_table_for_added_reward_tableId() const {return 461;};
