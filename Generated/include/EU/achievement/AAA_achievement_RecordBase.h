...
int step_complete_reward_item_tableId() const {return 195;};
...
int step_complete_reward_final_item_tableId() const {return 195;};
...
int title_image_text_tableId() const {return 420;};
BnsTables::Shared::TableRef title_thumbnail_icon_text;
int title_thumbnail_icon_text_tableId() const {return 420;};
__int16 sort_no;
char Pad9[2];
BnsTables::Shared::TableRef completed_game_message;
int completed_game_message_tableId() const {return 155;};
