...
int trait_symbol_tableId() const {return 192;};
__int16 trait_symbol_index;
char Pad2[2];
BnsTables::Shared::TableRef tooltip_train_name;
int tooltip_train_name_tableId() const {return 445;};
BnsTables::Shared::TableRef tooltip_train_description;
int tooltip_train_description_tableId() const {return 445;};
BnsTables::Shared::TableRef tooltip_effect_description;
int tooltip_effect_description_tableId() const {return 445;};
...
int tooltip_skill_systematization_group_tableId() const {return 387;};
...
int tooltip_acquire_skill_list_skill3_description_tableId() const {return 445;};
...
int tooltip_variable_skill_list_skill3_description_tableId() const {return 445;};
