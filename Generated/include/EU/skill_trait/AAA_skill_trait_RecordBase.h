...
int tooltip_train_name_tableId() const {return 426;};
BnsTables::Shared::TableRef tooltip_train_description;
int tooltip_train_description_tableId() const {return 426;};
BnsTables::Shared::TableRef tooltip_effect_description;
int tooltip_effect_description_tableId() const {return 426;};
...
int tooltip_skill_systematization_group_tableId() const {return 368;};
...
int tooltip_acquire_skill_list_skill3_description_tableId() const {return 426;};
...
int tooltip_variable_skill_list_skill3_description_tableId() const {return 426;};
